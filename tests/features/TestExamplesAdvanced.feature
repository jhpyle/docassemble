Feature: Example interviews
  ...
  Scenario: Test the interview "Review answers"
    Given I start the interview "docassemble.base:data/questions/examples/review-8a.yml"
    Then I should see the phrase "What is your address?"
    And I set "Street address" to "1234 Main St"
    And I set "City" to "Springfield"
    And I select "Ohio" as the "State"
    And I set "Zip" to "12345"
    And I click the button "Continue"
    Then I should see the phrase "All done"
    And I should see the phrase "You live in Clark County."
    And I click the link "Review your answers"
    Then I should see the phrase "Revisit your answers"
    And I should see the phrase "Your address is:"
    And I should see the phrase "This address is located in Clark County."
    And I click the link " Edit"
    Then I should see the phrase "What is your address?"
    And I click the button "Continue"
    Then I should see the phrase "Revisit your answers"
