Feature: Example interviews
  ...
  Scenario: Test the interview "Age of Individual"
    ...
    And I click the button "Continue"
    Then I should see the phrase "You are 49 years old"
...
#    And I should see "https://docassemble.org/demo.html" as the URL of the page
  ...
  Scenario: Test the interview "Sample version 2"
    ...
    And I click the button "No"
    Then I should see the phrase "When did you stop idolizing worms?"
    And I set "Date" to "04/01/2028"
    And I click the button "Continue"
    Then I should see the phrase "I can’t believe you don’t like turnips."
    And I should see the phrase "So, you idolize worms now, but plan to stop on April 1, 2028."
  ...
  Scenario: Test the interview "Confirm delete"
    Given I start the interview "docassemble.base:data/questions/examples/table-dict-confirm.yml"
    Then I should see the phrase "Income from benefits"
    And I click the option "Yes" under "Do you get income from benefits?"
    And I wait 1 second
    And I set "How much do you get from benefits?" to "400"
    And I click the button "Continue"
    Then I should see the phrase "Income from employment"
    And I click the option "No" under "Do you get income from employment?"
    And I click the button "Continue"
    Then I should see the phrase "Income from interest"
    And I click the option "No" under "Do you get income from interest?"
    And I click the button "Continue"
    Then I should see the phrase "Summary"
    # And I click the first link " Delete"
    # And I click accept in the alert
    # Then I should not see the phrase "benefits"

  Scenario: Test the interview "Collect"
    Given I start the interview "docassemble.base:data/questions/examples/list-collect-uncheck-others.yml"
    And I click the first option "Sweet"
    And I click the first option "Neither"
    And I unfocus
    And I wait 1 second
    And I click the second button " Delete"
    And I wait 1 second
    And I click the button "Continue"
    Then I should see the phrase "Summary of fruit"
    Then I should not see the phrase "Sweet"

  Scenario: Test the interview "From .md file from code"
  ...
  Scenario: Test the interview "Manual list"
    ...
    And I click the link " Add another"
    Then I should see the phrase "Who is the third person?"
    And I set "Name" to "Mary"
    And I click the button "Continue"
    Then I should see the phrase "All done"

  Scenario: Test the interview "Address block"
    Given I start the interview "docassemble.base:data/questions/examples/address-block.yml"
    Then I should see the phrase "What is your address?"
    And I set "Address" to "123 Main St"
    And I set "City" to "Springfield"
    And I set "State" to "MO"
    And I set "Postal Code" to "12121"
    And I select "United States" as the "Country"
    And I click the button "Continue"
    Then I should see the phrase "Your address block"
    And I should see the phrase "Springfield, MO 12121"
    And I should see the phrase "SPRINGFIELD, MO 12121"

  Scenario: Test the interview "Always including editable files"
    Given I start the interview "docassemble.base:data/questions/examples/always-include.yml"
    Then I should see the phrase "Your document is ready."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Attachment parts"
    Given I start the interview "docassemble.base:data/questions/examples/attachment-notice.yml"
    Then I should see the phrase "Here is your document."
    And I should not see the phrase "The following document has been created for you."

  Scenario: Test the interview "Catchall"
    Given I start the interview "docassemble.base:data/questions/examples/catchall-guess.yml"
    Then I should see the phrase "What is user name?"
    And I set the text box to "jsmith"
    And I click the button "Continue"
    Then I should see the phrase "How much is salary?"
    And I set "Amount" to "100"
    And I click the button "Continue"
    Then I should see the phrase "Summary"
    And I should see the phrase "Your name is jsmith."
    And I should see the phrase "You earn $100.00 each year."

  Scenario: Test the interview "Catchall"
    Given I start the interview "docassemble.base:data/questions/examples/catchall.yml"
    Then I should see the phrase "What is user name?"
    And I set the text box to "jsmith"
    And I click the button "Continue"
    Then I should see the phrase "How much is salary?"
  ...
  Scenario: Test the interview "Default date limits"
    Given I start the interview "docassemble.base:data/questions/examples/default-date-min.yml"
    Then I should see the phrase "What is the date?"
    And I set "Date" to "04/01/1989"
    And I click the button "Continue"
  ...
  Scenario: Test the interview "Customizing e-mailing"
    Given I start the interview "docassemble.base:data/questions/examples/document-email-custom.yml"
    Then I should see the phrase "Your document is ready."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Yes/no checkbox help"
    Given I start the interview "docassemble.base:data/questions/examples/fields-yesno-help.yml"
    Then I should see the phrase "Please provide the following information."
    And I set "What is your favorite food?" to "peaches"
    And I click the first choice help
    And I wait 1 second
    Then I should see the phrase "Round fruit of a tree of the rose family"
    And I unfocus
    And I click the option "Apples"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for that information."
    And I should see the phrase "You like apples. You do not like turnips."

  Scenario: Test the interview "Get PDF fields"
    Given I start the interview "docassemble.base:data/questions/examples/get-pdf-fields-2.yml"
    Then I should see the phrase "The field names in the PDF file"
    And I should see the phrase "[72.1975, 580.914, 94.395, 600.593]"

  Scenario: Test the interview "List of fields"
    Given I start the interview "docassemble.base:data/questions/examples/getFields.yml"
    Then I should see the phrase "Tell me about your musical tastes."
    And I click the button "Decide for me"
    And I click the button "Continue"
    Then I should see the phrase "You like Carly Simon."

  Scenario: Test the interview "Hyperlink style"
    Given I start the interview "docassemble.base:data/questions/examples/hyperlink-style.yml"
    Then I should see the phrase "What is your legal issue?"
    And I click the option "Wills"
    And I click the button "Continue"
    Then I should see the phrase "Here is your document."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Country code"
    Given I start the interview "docassemble.base:data/questions/examples/iso-country.yml"
    Then I should see the phrase "In what country do you live?"
    And I set "Country" to "United Kingdom"
    And I click the button "Continue"
    Then I should see the phrase "You live in United Kingdom."
    And I click the back button
    And I set "Country" to "Oceania"
    And I click the button "Continue"
    Then I should see the phrase "That country does not exist. Please try again."

  Scenario: Test the interview "Collect two"
    Given I start the interview "docassemble.base:data/questions/examples/list-collect-disable-others.yml"
    Then I should see the phrase "Tell me about the fruit."
    And I select "Orange" as the first "Fruit name"
    And I select "Grapefruit" as the second "Fruit name"
    And I click the button "Continue"
    Then I should see the phrase "Summary of fruit"
    And I should see the phrase "10"

  Scenario: Test the interview "Manual list"
    Given I start the interview "docassemble.base:data/questions/examples/list-table-manual-gather.yml"
    Then I should see the phrase "Who is the first person?"
    And I set "First Name" to "John"
    And I set "Last Name" to "Smith"
    And I click the button "Continue"
    ...
    And I click the button "Continue"
    Then I should see the phrase "Who is your favorite person?"
    And I select "Jane Smith" as the "Favorite"
    And I click the button "Continue"
    Then I should see the phrase "All done"
    And I should see the phrase "The people are John Smith and Jane Smith."
    And I should see the phrase "Your favorite is Jane Smith."
    And I should see the phrase "orange"

  Scenario: Test the interview "Manual Attachment List"
    Given I start the interview "docassemble.base:data/questions/examples/manual-attachment-list.yml"
    Then I should see the phrase "Here is your document."
    And I should see the phrase "Praecipe to Discontinue"
    And I should not see the phrase "The following document has been created for you."
    And I should see the phrase "E-mail this document"

  Scenario: Test the interview "Euros"
    Given I start the interview "docassemble.base:data/questions/examples/money-field-euro.yml"
    Then I should see the phrase "How much is your house worth?"
    And I should see the phrase "€"
    And I set "Value" to "323233"
    And I click the button "Continue"
    Then I should see the phrase "Your home value"
    And I should see the phrase "Your house is worth €323,233.00."

  Scenario: Test the interview "Reordered"
    Given I start the interview "docassemble.base:data/questions/examples/nested-objects-list.yml"
    Then I should see the phrase "What is the name of the first person?"
    And I set "First name" to "John"
    And I set "Last name" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "What is John Smith’s favorite food?"
    And I click the option "potato" under "Favorite"
    And I click the button "Continue"
    Then I should see the phrase "Are there any more people?"
    And I click the button "Yes"
    And I set "First name" to "Jane"
    And I set "Last name" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "What is Jane Smith’s favorite food?"
    And I click the option "broccoli" under "Favorite"
    And I click the button "Continue"
    Then I should see the phrase "Are there any more people?"
    And I click the button "No"
    Then I should see the phrase "Here are the people."

  Scenario: Test the interview "Generators"
    Given I start the interview "docassemble.base:data/questions/examples/generators.yml"
    Then I should see the phrase "How would you prefer to travel?"
    And I click the option " Bus"
    And I click the button "Continue"
    Then I should see the phrase "You will travel by bus."

  Scenario: Test the interview "On change"
    Given I start the interview "docassemble.base:data/questions/examples/on-change.yml"
    Then I should see the phrase "Are you married?"
    And I click the button "No"
    Then I should see the phrase "What is your first income source?"
    And I set "Name" to "employment"
    And I set "Amount per year" to "40000"
    And I click the button "Continue"
    Then I should see the phrase "Do you have any other income items?"
    And I click the button "No"
    Then I should see the phrase "Review your answers."
    And I click the link "Change this"
    Then I should see the phrase "Are you married?"
    And I click the button "Yes"
    Then I should see the phrase "What is the first income item that you and your spouse earn?"
    And I set "Amount per year" to "73400"
    And I click the button "Continue"
    Then I should see the phrase "Do you or your spouse have any other income items?"
    And I click the button "No"
    Then I should see the phrase "Review your answers."
    Then I should see the phrase "$73,400.00"

  Scenario: Test the interview "PDF fill-in"
    Given I start the interview "docassemble.base:data/questions/examples/pdf-fill-export-values.yml"
    Then I should see the phrase "Assembling a document from a PDF template"
    And I click the button "Continue"
    Then I should see the phrase "Please fill in the following information."
    And I set "Your First Name" to "John"
    And I set "Your Last Name" to "Smith"
    And I set "Your Organization" to "ABC Inc."
    And I click the button "Continue"
    Then I should see the phrase "Do you like apples?"
    And I click the button "Yes"
    Then I should see the phrase "Do you like oranges?"
    ...
    Then I should see the phrase "Here is your PDF form"
    And I should see the phrase "The following document has been created for you."
    And I should see the phrase "A filled-in form"

  Scenario: Test the interview "Skip undefined"
    Given I start the interview "docassemble.base:data/questions/examples/pdf-fill-skip-undefined.yml"
    Then I should see the phrase "Assembling a document from a PDF template"
    And I click the button "Continue"
    Then I should see the phrase "Please fill in the following information."
    And I set "Your First Name" to "John"
  ...
  Scenario: Test the interview "Persistent task results"
    Given I start the interview "docassemble.base:data/questions/examples/persistent-task.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I should see the phrase "The task has not been performed."
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "You like apple"
    And I should see the phrase "The task has been performed."
    And I click the back button
    Then I should see the phrase "The task has been performed."

  Scenario: Test the interview "Text after the question"
    Given I start the interview "docassemble.base:data/questions/examples/post.yml"
    Then I should see the phrase "What is the airspeed velocity of an unladen swallow?"
    And I should see the phrase "This is the post, which comes after under."
    And I set "Velocity" to "43"
    And I click the button "Continue"
    Then I should see the phrase "The velocity is 43."

  Scenario: Test the interview "Text before the question"
    Given I start the interview "docassemble.base:data/questions/examples/pre.yml"
    Then I should see the phrase "Note: if you do not catch the movie reference in this question, you need to improve your cultural literacy."
    And I should see the phrase "What is the airspeed velocity of an unladen swallow?"
    And I set "Velocity" to "43"
    And I click the button "Continue"
    Then I should see the phrase "The velocity is 43."

  Scenario: Test the interview "Vocabulary"
    Given I start the interview "docassemble.base:data/questions/examples/question-terms-alternate.yml"
    Then I should see the phrase "Have you ever met a creeper?"
    And I click the link "creeper"
    And I wait 1 second
    Then I should see the phrase "A tall green creature that explodes if you get too close."
  ...
  Scenario: Test the interview "Custom review button"
    Given I start the interview "docassemble.base:data/questions/examples/review-edit-list-custom-button.yml"
    Then I should see the phrase "Edit your answers"

  Scenario: Test the interview "Auto open"
    Given I start the interview "docassemble.base:data/questions/examples/sections-auto-open.yml"
    Then I should see the phrase "Contact info"

  Scenario: Test the interview "Navigation bar"
    Given I start the interview "docassemble.base:data/questions/examples/sections-small-screen-dropdown.yml"
    Then I should see the phrase "Welcome to the interview"

  Scenario: Test the interview "Navigation bar"
    Given I start the interview "docassemble.base:data/questions/examples/sections-small-screen-false.yml"
    Then I should see the phrase "Welcome to the interview"

  Scenario: Test the interview "Session local"
    Given I start the interview "docassemble.base:data/questions/examples/session-local.yml"
    Then I should see the phrase "How are you doing today?"
    And I click the option "Poorly"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Favorite fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple"
    And I should see the phrase "I am sorry you are poorly today."

  Scenario: Test the interview "Social meta tags"
    Given I start the interview "docassemble.base:data/questions/examples/social.yml"
    Then I should see the phrase "Meta tag demo"

  Scenario: Test the interview "Not available label"
    Given I start the interview "docassemble.base:data/questions/examples/table-not-available-label.yml"
    Then I should see the phrase "Do you have any fruit?"
    And I click the button "No"
    Then I should see the phrase "Information about fruit"
    And I should see the phrase "You do not have any fruit."

  Scenario: Test the interview "Not available label but there is fruit"
    Given I start the interview "docassemble.base:data/questions/examples/table-not-available-label.yml"
    Then I should see the phrase "Do you have any fruit?"
    And I click the button "Yes"
    Then I should see the phrase "What fruit should be added to the list?"
    ...
    And I set "Number of seeds" to "5"
    And I click the button "Continue"
    Then I should see the phrase "When did you last eat a apple?"
    And I click the button "Edit past answers"
    Then I should see the phrase "Review your answers"
    And I should not see the phrase "n/a"
    And I click the button "Resume"
    And I set "Date" to "04/05/2020"
    And I click the button "Continue"
    Then I should see the phrase "So far, the fruits include apple. Are there any others?"
    And I click the button "No"
    Then I should see the phrase "Information about fruit"
  ...
  Scenario: Test the interview "Require gathered"
    Given I start the interview "docassemble.base:data/questions/examples/table-require-gathered.yml"
    Then I should see the phrase "Do you have any fruit?"
    And I click the button "Yes"
    Then I should see the phrase "What fruit should be added to the list?"
    And I click the button "Edit past answers"
  ...
  Scenario: Test the interview "Show incomplete"
    Given I start the interview "docassemble.base:data/questions/examples/table-show-incomplete.yml"
    Then I should see the phrase "Do you have any fruit?"
    And I click the button "Yes"
    Then I should see the phrase "What fruit should be added to the list?"
    And I click the button "Edit past answers"
    Then I should see the phrase "Review your answers"
    And I should see the phrase "n/a"
    And I should see the phrase "Edit"

  Scenario: Test the interview "Template from file from code"
    Given I start the interview "docassemble.base:data/questions/examples/template-file-code.yml"
    Then I should see the phrase "Welcome to the interview!"
    And I should see the phrase "The opinions expressed herein do not necessarily reflect the views of ABC Widgets, Incorporated."
    And I click the button "Continue"
    Then I should see the phrase "This is the end of the interview."
  ...
  Scenario: Test the interview "Template"
    Given I start the interview "docassemble.base:data/questions/examples/template-show.yml"
    Then I should see the phrase "Welcome to the interview!"
    And I should see the phrase "The opinions expressed herein do not necessarily reflect the views of ABC Widgets, Incorporated."
    And I click the button "Continue"
    Then I should see the phrase "This is the end of the interview."
  ...
  Scenario: Test the interview "Vocabulary"
    Given I start the interview "docassemble.base:data/questions/examples/terms-alternate.yml"
    Then I should see the phrase "Have you ever met a creeper?"
    And I click the link "creeper"
    And I wait 1 second
    Then I should see the phrase "A tall green creature that explodes if you get too close."
  ...
  Scenario: Test the interview "Update Vocabulary"
    Given I start the interview "docassemble.base:data/questions/examples/update-terms.yml"
    Then I should see the phrase "Have you ever met a creeper?"
    And I click the link "zombie pigman"
    And I wait 1 second
    Then I should see the phrase "A nether dweller"
    And I click the button "No"
    Then I should see the phrase "You clearly need to play more Minecraft."

  Scenario: Test the interview "Verbatim"
    Given I start the interview "docassemble.base:data/questions/examples/verbatim.yml"
    Then I should see the phrase "Provide some text."
    And I set the text area to "This is **docassemble**."
    And I click the button "Continue"
    Then I should see the phrase "This content should be devoid of formatting."
    And I should see the phrase "This is **docassemble**."

  # Scenario: Test the interview ""
  #   Given I start the interview "docassemble.demo:data/questions/demo-basic-questions-address.yml"

  # Scenario: Test the interview ""
  #   Given I start the interview "docassemble.demo:data/questions/demo-basic-questions-name.yml"

  # Scenario: Test the interview "Basic questions"
  #   Given I start the interview "docassemble.demo:data/questions/demo-basic-questions.yml"

  Scenario: Test the interview "Ajax"
    Given I start the interview "docassemble.demo:data/questions/examples/ajax.yml"
    Then I should see the phrase "Guess my favorite fruit."
    And I set "Your guess" to "orange"
    And I click the button "Verify"
    And I wait 3 seconds
    Then I should see the phrase "You're totally wrong. I actually like apples."

  Scenario: Test the interview "Bates numbering"
    Given I start the interview "docassemble.demo:data/questions/examples/bates-number.yml"
    Then I should see the phrase "Upload a file"

  Scenario: Test the interview "Contract with clauses"
    Given I start the interview "docassemble.demo:data/questions/examples/clauses.yml"
    Then I should see the phrase "A contract"
    And I click the button "Continue"
    Then I should see the phrase "Is it necessary that we sign on the same sheets of paper?"
    And I click the button "No"
    Then I should see the phrase "The clauses"
    And I should see the phrase "This agreement may be signed in counterparts."
    And I click the button "Continue"
    Then I should see the phrase "Do you promise to give me your firstborn child?"
    And I click the button "Yes"
    Then I should see the phrase "Make any necessary changes to the firstborn clause."
    And I set the text area to "You *promise* unconditionally to give me your firstborn child."
    And I click the button "Continue"
    Then I should see the phrase "Sign your name"
    And I click inside the signature area
    And I click the button "Continue"
    Then I should see the phrase "Here is the contract."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Collating"
    Given I start the interview "docassemble.demo:data/questions/examples/collate.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the option "Yes" under "Do you have documentation of this?"
    And I wait 1 second
    Then I should see the phrase "Attach documentation"
    And I upload the file "/home/jpyle/da/tests/testfile.png"
    And I click the button "Continue"
    And I wait 2 seconds
    Then I should see the phrase "What is your favorite vegetable?"
    And I set "Vegetable" to "turnip"
    And I click the option "No" under "Do you have documentation of this?"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fungus?"
    And I set "Fungus" to "button mushrooms"
    And I click the option "No" under "Do you have documentation of this?"
    And I click the button "Continue"
  ...
  Scenario: Test the interview "Court filing"
    ...
    And I set "First Name" to "John"
    And I set "Last Name" to "Smith"
    And I set "E-mail address" to "jsmith@admin.com"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your Praecipe to Declare Favorite Fruit"
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Customizing date"
    Given I start the interview "docassemble.demo:data/questions/examples/customdate.yml"
    Then I should see the phrase "When were you born?"

  # Scenario: Test the interview "Get multiple signatures by e-mail"
  #   Given I start the interview "docassemble.demo:data/questions/examples/demo-multi-sign-2.yml"

  # Scenario: Test the interview "Get multiple signatures by e-mail"
  #   Given I start the interview "docassemble.demo:data/questions/examples/demo-multi-sign.yml"

  Scenario: Test the interview "Customizing common blocks"
    Given I start the interview "docassemble.demo:data/questions/examples/demo-with-basic-questions.yml"
    Then I should see the phrase "What is your name and e-mail address?"
    And I set "Name" to "John Smith"
    And I click the button "Continue"
    Then I should see the phrase "Where do you live?"
    And I set "Street address" to "123 Main St"
    And I set "City" to "Springfield"
    And I select "Missouri" as the "State"
    And I set "Zip code" to "12121"
    And I click the button "Continue"
    Then I should see the phrase "What is the name and e-mail address of the lawyer?"
    And I set "First name" to "Ralph"
    And I set "Last name" to "Enderman"
    And I set "E-mail" to "ralph@example.com"
    And I click the button "Continue"
    Then I should see the phrase "How can we send mail to the lawyer’s office?"
    And I set "Street address" to "424 Main St"
    And I set "City" to "Springfield"
    And I select "Missouri" as the "State"
    And I set "Zip code" to "12121"
    And I click the button "Continue"
    Then I should see the phrase "What is the name of antagonist?"
    And I click the button "Continue"
    Then I should see the phrase "What is the address of Brutus Morpheus?"
    And I set "Street address" to "623 Elm St"
    And I set "City" to "Springfield"
    And I select "Missouri" as the "State"
    And I set "Zip code" to "12121"
    And I click the button "Continue"
    Then I should see the phrase "What is the e-mail address of antagonist?"
    And I set "E-mail" to "brutus@example.com"
    And I click the button "Continue"
    Then I should see the phrase "Summary"

  Scenario: Test the interview "Excel data"
    Given I start the interview "docassemble.demo:data/questions/examples/fruits-database.yml"
    Then I should see the phrase "Pick a fruit."
    And I select "orange" as the "Fruit"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit, orange, is orange and has 4 seeds."

  Scenario: Test the interview "Hook on gather"
    Given I start the interview "docassemble.demo:data/questions/examples/hook-on-gather.yml"
    Then I should see the phrase "Income from benefits"
    And I click the option "No" under "Do you get income from benefits?"
    And I click the button "Continue"
    Then I should see the phrase "Income from employment"
    And I click the option "Yes" under "Do you get income from employment?"
    And I wait 1 second
    And I set "How much do you get from employment?" to "300"
    And I click the button "Continue"
    Then I should see the phrase "Income from interest"
    And I click the option "No" under "Do you get income from interest?"
    And I click the button "Continue"
    Then I should see the phrase "Summary"
    And I should see the phrase "Your total income is $300.00."
    And I click the second link " Edit"
    And I set "How much do you get from employment?" to "500"
    And I click the button "Continue"
    Then I should see the phrase "Your total income is $500.00."

  Scenario: Test the interview "Object in JSON form"
    Given I start the interview "docassemble.demo:data/questions/examples/jsondemo.yml"
    Then I should see the phrase "Do you have any favorite fruit?"
    And I click the button "Yes"
    Then I should see the phrase "Tell me about your first favorite fruit."
    And I set "Name" to "orange"
    And I click the button "Continue"
    Then I should see the phrase "Do you have any other favorite fruit besides orange?"
    And I click the button "No"
    Then I should see the phrase "You can use this to set the value of user.favorite_fruit using the POST /api/session API endpoint."

  Scenario: Test the interview "Jinja2 macros"
    Given I start the interview "docassemble.demo:data/questions/examples/macros.yml"
    Then I should see the phrase "The team"
    And I should see the phrase "The team leader is John Smith."
    And I click the button "Continue"
    Then I should see the phrase "Here is a description of the team."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Background OCR PDF"
    Given I start the interview "docassemble.demo:data/questions/examples/make-ocr-pdf-in-background.yml"
  ...
  Scenario: Test the interview "OCR PDF"
    Given I start the interview "docassemble.demo:data/questions/examples/make-ocr-pdf.yml"
    Then I should see the phrase "Upload a PDF file or image."
    And I upload the file "/home/jpyle/da/tests/testfile2.png"
    And I click the button "Continue"
    And I wait 20 seconds
  ...
  #   Given I start the interview "docassemble.demo:data/questions/examples/multi-signature.yml"

  # Scenario: Test the interview "OAuth with Google"
  #   Given I start the interview "docassemble.demo:data/questions/examples/oauth-test-2.yml"

  # Scenario: Test the interview "OAuth with Google"
  #   Given I start the interview "docassemble.demo:data/questions/examples/oauth-test-3.yml"

  # Scenario: Test the interview "OAuth with Google"
  #   Given I start the interview "docassemble.demo:data/questions/examples/oauth-test-4.yml"

  Scenario: Test the interview "Object checkboxes conversion"
    Given I start the interview "docassemble.demo:data/questions/examples/object-checkboxes-copy.yml"
    Then I should see the phrase "What is the name of the first person?"
    And I set "First name" to "John"
    And I set "Last name" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "Which fruits does John Smith like?"
    And I click the option "apple" under "Fruits"
    And I click the option "pear" under "Fruits"
    And I click the button "Continue"
    Then I should see the phrase "How many seeds does John Smith’s ideal apple have?"
    And I set "Seeds" to "3"
    And I click the button "Continue"
    Then I should see the phrase "How many seeds does John Smith’s ideal pear have?"
    And I click the button "Continue"
    Then I should see the phrase "Is there another person you would like to add?"
    And I click the button "No"
    Then I should see the phrase "On the next screen you will see a JSON representation of the fruit_data and person objects."

  Scenario: Test the interview "Set variable to list of objects"
    Given I start the interview "docassemble.demo:data/questions/examples/object-checkboxes-custom.yml"
    Then I should see the phrase "Who are the villains, if any?"
    And I click the option "Harry Potter"
    And I click the button "Continue"
    Then I should see the phrase "The villain includes Harry Potter."
    And I should see the phrase "The class name of villain is PartyList."

  Scenario: Test the interview "Objects from JSON"
    Given I start the interview "docassemble.demo:data/questions/examples/objects-from-file-json.yml"
    Then I should see the phrase "How to contact us"
    And I should see the phrase "You can e-mail Fred Smith at fred@example.com."
  ...
  Scenario: Test the interview "Phone number"
    ...
    Then I should see the phrase "Is your mobile phone number based in the United States or Canada?"
    And I click the button "Another country"
    Then I should see the phrase "What country is associated with your mobile phone number?"
    And I choose "France"
    And I click the button "Continue"
    Then I should see the phrase "What is your phone number?"
    And I set "Phone number" to "05 56 81 94 55"
    And I click the button "Continue"
    Then I should see the phrase "I will text you at +33556819455."

  Scenario: Test the interview "Dependency satisfaction"
    ...
    And I click the button "Continue"
    Then I should explicitly see the phrase "Reference to undefined variable in context where dependency satisfaction not allowed"

  Scenario: Test the interview "DOM"
    Given I start the interview "docassemble.demo:data/questions/examples/pytojs-dom.yml"
    Then I should see the phrase "What are your favorites?"
    And I set "Color" to "red"
    And I set "Flavor" to "cherry"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
  ...
  # Scenario: Test the interview "Hidden"
  #   Given I start the interview "docassemble.demo:data/questions/examples/pytojs-hidden.yml"

  Scenario: Test the interview "log"
    Given I start the interview "docassemble.demo:data/questions/examples/pytojs-log.yml"
    Then I should see the phrase "What is your favorite color?"
    And I set "Color" to "red"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorites"
    Then I should see the phrase "Your favorite fruit is apple."

  Scenario: Test the interview "script"
    Given I start the interview "docassemble.demo:data/questions/examples/pytojs-script.yml"
    Then I should see the phrase "What is your favorite color?"
    And I set "Color" to "red"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
  ...
  Scenario: Test the interview "Predictive analytics"
    Given I start the interview "docassemble.demo:data/questions/examples/random-forest-interview.yml"
  ...
  Scenario: Test the interview "Predictive analytics"
    Given I start the interview "docassemble.demo:data/questions/examples/random-forest.yml"
    Then I should see the phrase "The prediction"

  Scenario: Test the interview "Raw assembly"
    Given I start the interview "docassemble.demo:data/questions/examples/raw.yml"
    Then I should see the phrase "Should we say hello?"
    And I click the button "Yes"
    Then I should see the phrase "To what planet shall we say hello?"
    And I set "Planet" to "Pluto"
    And I click the button "Continue"
    Then I should see the phrase "Here is the source code."
    And I should see the phrase "hello_world.cpp"

  Scenario: Test the interview "Repeatable with defaults"
    Given I start the interview "docassemble.demo:data/questions/examples/repeatable.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
    ...
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite apple?"
    And I set "Apple" to "Fuji apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite apple is Fuji apple"

  # Scenario: Test the interview "Version API"
  #   Given I start the interview "docassemble.demo:data/questions/examples/report-version.yml"

  Scenario: Test the interview "Read before signing"
    Given I start the interview "docassemble.demo:data/questions/examples/signature-preview.yml"
    Then I should see the phrase "What is your name?"
    And I set "First Name" to "John"
    And I set "Last Name" to "Smith"
    And I click the button "Continue"
    ...
    And I click the button "Continue"
    Then I should see the phrase "What objects do you collect?"
    And I set "Collection" to "baseball cards"
    And I click the button "Continue"
    Then I should see the phrase "Your draft document"
    And I should see the phrase "The following document has been created for you."
    And I click the button "Continue"
    Then I should see the phrase "Please sign your name below."
    And I click inside the signature area
  ...
  # Scenario: Test the interview ""
  #   Given I start the interview "docassemble.demo:data/questions/examples/signdoc.yml"

  Scenario: Test the interview "Single code"
    Given I start the interview "docassemble.demo:data/questions/examples/single-code.yml"
    Then I should see the phrase "Do you like fruit?"
    And I click the button "Yes"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Do you like to put fruit in smoothies?"
    And I click the button "No"
  ...
  Scenario: Test the interview "Stage one"
    ...
    And I click the button "Continue"
    Then I should see the phrase "All done"
    And I click the link "Proceed to the next part"
    Then I should see the phrase "John Smith, I know you like peach, but what is your favorite vegetable?"
    And I set "Vegetable" to "turnip"
    And I click the button "Continue"
    Then I should see the phrase "You like peach and turnip."
  ...
  Scenario: Test the interview "Action in other session"
    Given I start the interview "docassemble.demo:data/questions/examples/primary-interview.yml"
    Then I should see the phrase "Press Continue to start a new session in docassemble.demo:data/questions/examples/secondary-interview.yml."
    And I click the button "Continue"
    Then I should see the phrase "The session ID of the other session is"
    And I click the button "Continue"
    Then I should see the phrase "The favorite fruit in the other session is now apple."
    And I click the button "Continue"
  ...
  Scenario: Test the interview "Ajax Combobox"
    ...
    And I unfocus
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is y432."

  Scenario: Test the interview "Actions demonstration"
    Given I start the interview "docassemble.base:data/questions/examples/actions-demo.yml"
    Then I should see the phrase "Each of the links below calls a particular action."
    And I click the link "Variable defined by question"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Favorite fruit" to "apple"
    And I click the button "Continue"
    And I click the link "Variable defined by question"
    Then I should see the phrase "What is your favorite fruit?"
    And I click the button "Continue"
    And I click the link "event question"
    Then I should see the phrase "Information about fruit"
    And I click the button "Continue"
    And I click the link "Variable defined by code"
    Then I should see the phrase "Introduction to vegetables"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
    And I set "Favorite vegetable" to "turnips"
    And I click the button "Continue"
    Then I should see the phrase "Each of the links below calls a particular action."
    And I click the link "event code"
    Then I should see the phrase "Each of the links below calls a particular action."
    And I click the link "event code that calls force_ask()"
    Then I should see the phrase "What is your favorite fruit?"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
    And I click the button "Continue"
  ...
  # Scenario: Test the interview "Address autocomplete on cities"
  #   Given I start the interview "docassemble.base:data/questions/examples/address-autocomplete-cities.yml"

  # Scenario: Test the interview "Address autocomplete on establishments"
  #   Given I start the interview "docassemble.base:data/questions/examples/address-autocomplete-establishment.yml"

  # Scenario: Test the interview "Address autocomplete on regions"
  #   Given I start the interview "docassemble.base:data/questions/examples/address-autocomplete-regions.yml"

  # Scenario: Test the interview "Address autocomplete on specific establishments"
  #   Given I start the interview "docassemble.base:data/questions/examples/address-autocomplete-specific.yml"

  Scenario: Test the interview "Buttons defined with code using label and value"
    Given I start the interview "docassemble.base:data/questions/examples/buttons-code-list-label-value.yml"
    Then I should see the phrase "Your use of this system does not mean that you have a lawyer. Do you understand this?"
    And I click the button "I understand"
    Then I should see the phrase "target_variable is: “understands”"
    And I click the back button
  ...
  Scenario: Test the interview "DAStore Update"
    Given I start the interview "docassemble.base:data/questions/examples/dastore2.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."

  Scenario: Test the interview "Markdown format"
    Given I start the interview "docassemble.base:data/questions/examples/document-md.yml"
    Then I should see the phrase "Here is your document."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "CSS Class"
    Given I start the interview "docassemble.base:data/questions/examples/field-css-class.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."

  # Scenario: Test the interview "Address autocomplete with hidden field"
  #   Given I start the interview "docassemble.base:data/questions/examples/fields-hidden-autocomplete.yml"

  Scenario: Test the interview "Hidden field"
    Given I start the interview "docassemble.base:data/questions/examples/fields-hidden.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple and your favorite vegetable is turnip."

  Scenario: Test the interview "Multiple choice with code using label and value"
    Given I start the interview "docassemble.base:data/questions/examples/fields-mc-9.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I click the "Apples" option
    And I click the button "Continue"
    Then I should see the phrase "What is your brother’s favorite fruit?"
  ...
  Scenario: Test the interview "Rows in multiselect"
    Given I start the interview "docassemble.base:data/questions/examples/fields-multiselect-rows.yml"
    Then I should see the phrase "Please tell me what you think."
    And I select "apple" as the "Select the fruits you like"
    And I set "What is your favorite fruit overall?" to "strawberry"
    And I click the button "Continue"
    Then I should see the phrase "You like apples. Your favorite, though, is strawberry."

  Scenario: Test the interview "Multiselect"
    Given I start the interview "docassemble.base:data/questions/examples/fields-multiselect.yml"
    Then I should see the phrase "Please tell me what you think."
    And I select "apple" as the "Select the fruits you like"
    And I set "What is your favorite fruit overall?" to "strawberry"
    And I click the button "Continue"
  ...
  Scenario: Test the interview "Floating label"
    Given I start the interview "docassemble.base:data/questions/examples/floating-label.yml"
    Then I should see the phrase "Your sign"
    And I set "What is your Zodiac sign?" to "Aries"
    And I click the button "Continue"
    Then I should see the phrase "target_variable is: “Aries”"

  Scenario: Test the interview "Actions demonstration"
    Given I start the interview "docassemble.base:data/questions/examples/force-ask-forget-prior.yml"
    Then I should see the phrase "First page"
    And I click the link "Go to second page"
    Then I should see the phrase "Second page"
    And I click the link "Go to third page"
    Then I should see the phrase "Third page"
    And I click the link "Ask about food"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Favorite fruit" to "apple"
    And I click the button "Continue"
    ...
    And I click the button "Continue"
    Then I should see the phrase "Third page"
    And I click the link "Ask about food with forget prior"
    Then I should see the phrase "What is your favorite fruit?"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
    And I click the button "Continue"
  ...
  Scenario: Test the interview "Actions demonstration"
    Given I start the interview "docassemble.base:data/questions/examples/forget-prior.yml"
    Then I should see the phrase "First page"
    And I click the link "Go to second page"
    Then I should see the phrase "Second page"
    And I click the link "Go to third page"
    Then I should see the phrase "Third page"
    And I click the link "Go to fourth page"
    Then I should see the phrase "Fourth page"
    And I click the button "Continue"
    Then I should see the phrase "Third page"
    And I click the link "Go to fourth page with forget prior"
    Then I should see the phrase "Fourth page"
    And I click the button "Continue"
    Then I should see the phrase "First page"

  Scenario: Test the interview "Label above field"
    Given I start the interview "docassemble.base:data/questions/examples/label-above-field.yml"
    Then I should see the phrase "Your sign"
    And I set "What is your Zodiac sign?" to "Aries"
    And I click the button "Continue"
    Then I should see the phrase "target_variable is: “Aries”"
  ...
  Scenario: Test the interview "Set variable to list of objects"
    Given I start the interview "docassemble.base:data/questions/examples/object-multiselect-dalist.yml"
    Then I should see the phrase "Who are the villains, if any?"
  ...
  Scenario: Test the interview "Tables in Markdown"
    Given I start the interview "docassemble.base:data/questions/examples/table-markdown-class.yml"
    Then I should see the phrase "Your vegetable inventory"
    And I should see the phrase "Brocolli"

  Scenario: Test the interview "Simple logic"
    Given I start the interview "docassemble.demo:data/questions/examples/all-mandatory.yml"
    Then I should see the phrase "Welcome to the interview!"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
  ...
  Scenario: Test the interview "Simple logic"
    Given I start the interview "docassemble.demo:data/questions/examples/branch-mandatory.yml"
    Then I should see the phrase "Welcome to the interview!"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite type of apple?"
    And I set "Type of apple" to "fuji"
    And I click the button "Continue"
    Then I should see the phrase "Here is your document."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Button style checkboxes"
    Given I start the interview "docassemble.demo:data/questions/examples/button-checkboxes.yml"
    Then I should see the phrase "Please tell me what you think."
  ...
  Scenario: Test the interview "Using redis"
    Given I start the interview "docassemble.demo:data/questions/examples/counter.yml"
    Then I should see the phrase "Thank you for starting the interview!"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    ...
    And I click the button "Continue"
    Then I should see the phrase "What is your name?"
    And I set "Name" to "Roger"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for providing this information."
    And I should see the phrase "The following document has been created for you."

  # Scenario: Test the interview "Globally stored object"
  #   Given I start the interview "docassemble.demo:data/questions/examples/daglobal.yml"

  Scenario: Test the interview "Dependency Satisfaction"
    Given I start the interview "docassemble.demo:data/questions/examples/dependency-demo-code.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
  ...
  Scenario: Test the interview "Dependency Satisfaction"
    Given I start the interview "docassemble.demo:data/questions/examples/dependency-demo.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."

  Scenario: Test the interview "Duplicate session"
    Given I start the interview "docassemble.demo:data/questions/examples/duplicate.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."
    And I click the link "duplicate this session"
    Then I should see the phrase "A duplicate session has been created"
    And I click the link "duplicate session"
    Then I should see the phrase "Your favorite fruit is apple."
    And I should see the phrase "Favorite fruit receipt"

  # Scenario: Test the interview "Profile"
  #   Given I start the interview "docassemble.demo:data/questions/examples/globalprofile.yml"

  # Scenario: Test the interview "Profile"
  #   Given I start the interview "docassemble.demo:data/questions/examples/globalprofile2.yml"
  ...
  Scenario: Test the interview "Reporting database"
    ...
    Then I should see the phrase "What is your name?"
    And I set "First" to "Thomas"
    And I set "Last" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit, Thomas Smith?"
    And I set "Fruit" to "orange"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
    And I set "Vegetable" to "potato"
  ...
  Scenario: Test the interview "Querying database"
    Given I start the interview "docassemble.demo:data/questions/examples/indexdemoquery.yml"
    Then I should see the phrase "People who have used the interview in the last month"
    And I should see the phrase "Thomas Smith"

  # Scenario: Test the interview "Using Jinja2 in YAML included file"
  #   Given I start the interview "docassemble.demo:data/questions/examples/jinjayaml-included.yml"

  Scenario: Test the interview "Using Jinja2 in YAML"
    Given I start the interview "docassemble.demo:data/questions/examples/jinjayaml.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."
    And I should see the phrase "docassemble.demo:data/questions/examples/jinjayaml.yml"

  Scenario: Test the interview "OCR PDF"
    Given I start the interview "docassemble.demo:data/questions/examples/make-ocr-pdf-in-background-2.yml"
    Then I should see the phrase "Upload some files and I will OCR them for you."

  Scenario: Test the interview "Fruit"
    Given I start the interview "docassemble.demo:data/questions/examples/navbar-language.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."

  Scenario: Test the interview "Nested list in template"
    Given I start the interview "docassemble.demo:data/questions/examples/nested-list-docx-table.yml"
    Then I should see the phrase "Tell me about the first variety of apple."
    And I set "Variety" to "Fuji"
    And I set "Cost" to "45"
    And I click the button "Continue"
    Then I should see the phrase "Are there more apples besides Fuji?"
    And I click the button "Yes"
    Then I should see the phrase "Tell me about the second variety of apple."
    And I set "Variety" to "Gala"
    And I set "Cost" to "25"
    And I click the button "Continue"
    Then I should see the phrase "Are there more apples besides Fuji and Gala?"
    And I click the button "No"
    Then I should see the phrase "Tell me about the first variety of orange."
    And I set "Variety" to "Tangerine"
    And I set "Cost" to "10"
    And I click the button "Continue"
    Then I should see the phrase "Are there more oranges besides Tangerine?"
    And I click the button "Yes"
    Then I should see the phrase "Tell me about the second variety of orange."
    And I set "Variety" to "Clementine"
    And I set "Cost" to "63"
    And I click the button "Continue"
    Then I should see the phrase "Are there more oranges besides Tangerine and Clementine?"
    And I click the button "No"
    Then I should see the phrase "Here is a summary of the fruit you listed."

  Scenario: Test the interview "Overlay Multi"
    Given I start the interview "docassemble.demo:data/questions/examples/overlay-pdf-multi.yml"
    Then I should see the phrase "Upload a PDF file."

  Scenario: Test the interview "Extract pages from PDF"
    Given I start the interview "docassemble.demo:data/questions/examples/pdfextract.yml"
    Then I should see the phrase "Upload a PDF document at least 6 pages long."

  # Scenario: Test the interview "Template from Google Drive"
  #   Given I start the interview "docassemble.demo:data/questions/examples/realtimegd.yml"

  # Scenario: Test the interview "Template from Google Drive"
  #   Given I start the interview "docassemble.demo:data/questions/examples/realtimegd2.yml"

  # Scenario: Test the interview "Secondary interview"
  #   Given I start the interview "docassemble.demo:data/questions/examples/secondary-interview.yml"

  Scenario: Test the interview "Custody Complaint"
    Given I start the interview "docassemble.demo:data/questions/examples/setparts.yml"
    Then I should see the phrase "What is your name?"
    And I set "First name" to "Susan"
    And I set "Last name" to "Jones"
    And I click the button "Continue"
    Then I should see the phrase "What is your relation to the child?"
    And I click the "Parent" option
    And I click the button "Continue"
    Then I should see the phrase "Here is your complaint"

  Scenario: Test the interview "Cards"
    Given I start the interview "docassemble.demo:data/questions/examples/testcards.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I should see the phrase "We need to know your favorite fruit because if your favorite fruit is not a fruit that we think is tasty, then behind your back we will report you to the police."
    And I select "Apple" as the "Fruit"
    And I wait 1 second
    Then I should see the phrase "The real truth about apples"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apples."

  Scenario: Test the interview "Watermark"
    Given I start the interview "docassemble.demo:data/questions/examples/watermark.yml"
    Then I should see the phrase "What is the name of the planet you wish to greet?"
    And I set "Planet" to "Saturn"
    And I click the button "Continue"
    Then I should see the phrase "The following document has been created for you."

  # Scenario: Test the interview "test permissions"
  #   Given I start the interview "docassemble.demo:data/questions/testpermissions.yml"
  ...
  Scenario: Test the interview "Buttons defined with code using label and value"
    Given I start the interview "docassemble.base:data/questions/examples/buttons-code-list-label-value-datatype.yml"
    Then I should see the phrase "Your use of this system does not mean that you have a lawyer. Do you understand this?"
    And I should see the phrase "I understand"
    And I should see the phrase "I do not understand"
    And I click the button "I understand"
    Then I should see the phrase "target_variable is: True"

  Scenario: Test the interview "Customized buttons"
    Given I start the interview "docassemble.base:data/questions/examples/buttons-css-class-color.yml"
    Then I should see the phrase "What is your gender?"
    And I click the button "Male"
    Then I should see the phrase "Result of question"
    And I should see the phrase "You are male."

  Scenario: Test the interview "Conditional buttons"
    Given I start the interview "docassemble.base:data/questions/examples/buttons-show-if.yml"
    Then I should see the phrase "Are you able to digest gluten?"
    And I click the button "Yes"
    Then I should see the phrase "Which flour shall we use?"
    Then I should see the phrase "Almond"
    And I should see the phrase "Oat"
    And I should see the phrase "Wheat"
    And I should see the phrase "Spelt"
    And I click the back button
    And I click the button "No"
    Then I should see the phrase "Which flour shall we use?"
    And I should see the phrase "Almond"
    And I should see the phrase "Oat"
    And I should not see the phrase "Wheat"
    And I should not see the phrase "Spelt"
    And I click the button "Oat"
    Then I should see the phrase "The variable is oat."

  Scenario: Test the interview "Customized radio buttons"
    Given I start the interview "docassemble.base:data/questions/examples/choices-css-class-color.yml"
    Then I should see the phrase "What type of shoes do you wear?"
    And I click the button "Continue"
    Then I should see the phrase "Result of question"

  Scenario: Test the interview "Conditional radio buttons"
    Given I start the interview "docassemble.base:data/questions/examples/choices-show-if.yml"
    Then I should see the phrase "Are you proper?"
    And I click the button "Yes"
    Then I should see the phrase "What type of shoes do you wear?"
    And I should see the phrase "Dress shoes"
    And I should see the phrase "Boat shoes"
    And I should not see the phrase "Sneakers"
    And I should not see the phrase "Sandals"
    And I should not see the phrase "Crocs"
    And I should see the phrase "Other"
    And I click the back button
    And I click the button "No"
    Then I should see the phrase "What type of shoes do you wear?"
    And I should not see the phrase "Dress shoes"
    And I should not see the phrase "Boat shoes"
    Then I should see the phrase "Sneakers"
    Then I should see the phrase "Sandals"
    Then I should see the phrase "Crocs"
    And I should see the phrase "Other"
    And I click the option "Crocs"
    And I click the button "Continue"
    Then I should see the phrase "Result of question"

  Scenario: Test the interview "Custom continue button color"
    Given I start the interview "docassemble.base:data/questions/examples/continue-button-color.yml"
    And I set "Fruit" to "apple"
    And I click the button "Keep going"
    Then I should see the phrase "Your favorite fruit is apple."

  Scenario: Test the interview "Update dropdown"
    Given I start the interview "docassemble.base:data/questions/examples/country-state.yml"
    Then I should see the phrase "Where do you live?"
    And I select "Portugal" as the "Country"
    And I wait 2 seconds
    And I select "Bragança" as the "State"
    And I click the button "Continue"
    Then I should see the phrase "You live in Bragança in Portugal."
    And I should see the phrase "Your country code is PT."
    And I should see the phrase "Your state code is 04."

  Scenario: Test the interview "Data structure"
    Given I start the interview "docassemble.base:data/questions/examples/data-code-objects.yml"
    Then I should see the phrase "The object is rocks and its size is 8."

  Scenario: Test the interview "Disable continue button"
    Given I start the interview "docassemble.base:data/questions/examples/disable-continue-button.yml"
    Then I should see the phrase "Remember this number:"
    And I click the button "Continue"
    Then I should see the phrase "What was the number I asked you to remember?"
    And I set "Number" to "-1"
    And I click the button "Continue"
    Then I should see the phrase "You are wrong."
    And I click the button "Try again"
    Then I should see the phrase "What was the number I asked you to remember?"

  Scenario: Test the interview "All of the above"
    Given I start the interview "docassemble.base:data/questions/examples/fields-checkboxes-aota.yml"
    Then I should see the phrase "Please tell me what you think."
    And I click the "All of the above" option under "Select the fruits you like"
    And I set "What is your favorite fruit overall?" to "pears"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for your thoughts."
    And I should see the phrase "You like apples. You like peaches. You like pears."
    And I should see the phrase "In other words, you like Apples, Peaches, and Pears."
    And I should see the phrase "Your favorite, though, is pears."

  Scenario: Test the interview "DADict methods"
    Given I start the interview "docassemble.base:data/questions/examples/fields-checkboxes-dadict.yml"
    Then I should see the phrase "Please tell me what you think."
    And I click the "Pears" option under "Select the fruits you like"
    And I set "What is your favorite fruit overall?" to "pears"
    And I click the button "Continue"
    Then I should see the phrase "Your fruit preferences"
    And I should see the phrase "You like at least one fruit."
    And I should see the phrase "There is at least one fruit you don’t like."

  Scenario: Test the interview "Checkboxes with label value pairs"
    Given I start the interview "docassemble.base:data/questions/examples/fields-checkboxes-label-value.yml"
    Then I should see the phrase "Please tell me what you think."
    And I click the "Pears" option under "Select the fruits you like"
    And I set "What is your favorite fruit overall?" to "pears"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for your thoughts."
    And I should see the phrase "You like pears."
    And I should see the phrase "In other words, you like pear."
    And I should see the phrase "Your favorite, though, is pears."
    And I should see the phrase "'pear': True"
    And I should see the phrase "'apple': False"
    And I should see the phrase "'peach': False"

  Scenario: Test the interview "All of the above customized"
    Given I start the interview "docassemble.base:data/questions/examples/fields-mc-aota.yml"
    Then I should see the phrase "Please fill in the following information."
    And I click the option "I want to pay a lot" under "Requested options"
    And I click the button "Continue"
    Then I should see the phrase "Your car options"
    And I should see the phrase "You want Sunroof. You want Automatic transmission. You want Heated seats."

  Scenario: Test the interview "Yes/no checkboxes with All of the above"
    Given I start the interview "docassemble.base:data/questions/examples/fields-yesno-check-others-list.yml"
    Then I should see the phrase "Please provide the following information."
    And I set "What is your favorite food?" to "bubble tea"
    And I click the option "Both"
    And I click the option "I like both of these rocks"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for that information."
    And I should see the phrase "You like bubble tea."
    And I should see the phrase "You like apples. You like turnips. You like granite. You like obsidian."

  Scenario: Test the interview "Yes/no checkboxes with All of the above"
    Given I start the interview "docassemble.base:data/questions/examples/fields-yesno-check-others.yml"
    Then I should see the phrase "Please provide the following information."
    And I set "What is your favorite food?" to "bubble tea"
    And I click the option "Both"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for that information."
    And I should see the phrase "You like bubble tea."
    And I should see the phrase "You like apples. You like turnips."

  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid1.yml"
    Then I should see the phrase "Tell me about yourself."
    And I set "Name" to "Fred"
    And I set "Age" to "22"
    And I set "Life story" to "I was raised by emus and later got a job in accounts payable."
    And I click the button "Continue"
    Then I should see the phrase "Greetings, Fred!"

  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid2.yml"
    Then I should see the phrase "Let’s pick some numbers."
    And I should see the phrase "3"
    And I click the "Yes" option under "Are you afraid of odd numbers?"
    And I wait 1 second
    Then I should not see the phrase "3"
    And I click the "2" option
    And I click the "4" option
    And I click the button "Continue"
    Then I should see the phrase "I agree, odd numbers are scary."

  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid3.yml"
    Then I should see the phrase "Tell me about your numerical tastes."
    And I set "Best number" to "42"
    And I set "Worst number" to "666"
    And I click the button "Continue"
    Then I should see the phrase "I am also a fan of 42."

  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid4.yml"
    Then I should see the phrase "Tell me about your numerical tastes."
    And I set "Best number" to "42"
    And I set "Worst number" to "666"
    And I click the button "Continue"
  ...
  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid5.yml"
    Then I should see the phrase "Let’s pick some numbers and letters."
    And I click the "2" option
    And I click the "4" option
    And I click the "B" option
    And I click the "D" option
    And I click the button "Continue"
    Then I should see the phrase "You did not pick 1."

  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid6.yml"
    Then I should see the phrase "Let’s pick some numbers and letters."
    And I click the "2" option
    And I click the "4" option
    And I click the "B" option
  ...
  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid7.yml"
    Then I should see the phrase "Tell me your address."
    And I set "Address" to "123 Main St"
    And I set "City" to "Springfield"
    And I select "IL" as the "State"
    And I set "Zip" to "12345"
    And I click the button "Continue"
    Then I should see the phrase "Your address"

  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid8.yml"
    Then I should see the phrase "Tell me your address."
    And I set "Address" to "123 Main St"
    And I set "City" to "Springfield"
    And I select "IL" as the "State"
  ...
  Scenario: Test the interview "Fields in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/grid9.yml"
    Then I should see the phrase "How many fingers do you have?"
    And I set "Left hand" to "5"
    And I set "Right hand" to "5"
    And I click the option "A"
    And I click the option "D"
    And I click the button "Continue"
    Then I should see the phrase "You have ten fingers."

  Scenario: Test the interview "Hide continue button"
    Given I start the interview "docassemble.base:data/questions/examples/hide-continue-button.yml"
    Then I should see the phrase "Remember this number:"
    And I click the button "Continue"
    Then I should see the phrase "What was the number I asked you to remember?"
    And I set "Number" to "-1"
  ...
  Scenario: Test the interview "Continue button"
    Given I start the interview "docassemble.base:data/questions/examples/mandatory-continue.yml"
    Then I should see the phrase "Please note that this app is only right for you if you are a bear."
    And I click the button "Continue"
    Then I should see the phrase "Instructions for bears"

  Scenario: Test the interview "Review answers in tabular form"
    Given I start the interview "docassemble.base:data/questions/examples/review-tabular-class.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set the text box to "orange"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
    ...
    Then I should see the phrase "Revisit your answers"
    And I should see the phrase "You said your favorite fruit was orange."
    And I should see the phrase "You said your favorite vegetable was turnip."
    And I should see the phrase "You said your favorite fungus was button mushrooms."
    And I click the button "Resume"
    Then I should see the phrase "You like orange, turnip, and button mushrooms."

  Scenario: Test the interview "Review answers in tabular form"
    Given I start the interview "docassemble.base:data/questions/examples/review-tabular.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set the text box to "orange"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
  ...
  Scenario: Test the interview "Signature color"
    Given I start the interview "docassemble.base:data/questions/examples/signature-blue.yml"
    Then I should see the phrase "Sign your name"
    And I click inside the signature area
    And I click the button "Continue"
    Then I should see the phrase "Result of question"
  ...
  Scenario: Test the interview "Table gather"
    Given I start the interview "docassemble.base:data/questions/examples/tablegather.yml"
    Then I should see the phrase "Parties to the case"
    And I click the button " Add a party"
    Then I should see the phrase "What is the name of the first party?"
    And I set "First name" to "Thomas"
    And I set "Last name" to "Jones"
    And I click the button "Continue"
    Then I should see the phrase "Is Thomas Jones a plaintiff or a defendant?"
    And I click the option "Plaintiff"
    And I click the button "Continue"
    Then I should see the phrase "Parties to the case"
    Then I should see the phrase "Thomas Jones"
    And I click the first link " Edit"
    And I set "First name" to "Sally"
    And I set "Last name" to "Smith"
    And I click the button "Continue"
    And I click the option "Defendant"
    And I click the button "Continue"
    Then I should see the phrase "Parties to the case"
    And I should see the phrase "Sally Smith"
    And I should not see the phrase "Thomas Jones"
    And I click the button " Add another party"
    Then I should see the phrase "What is the name of the second party?"
    And I set "First name" to "Kerry"
    And I set "Last name" to "Turban"
    And I click the button "Continue"
    Then I should see the phrase "Is Kerry Turban a plaintiff or a defendant?"
    And I click the option "Plaintiff"
    And I click the button "Continue"
    Then I should see the phrase "Parties to the case"
    And I click the button "Continue"
    Then I should see the phrase "Summary of case"

  # Scenario: Test the interview "Disabling file-input plugin"
  #   Given I start the interview "docassemble.base:data/questions/examples/upload-plain.yml"
  #   Then I should see the phrase "Please upload a JPEG or PNG of yourself."
  #   And I upload the file "/home/jpyle/da/tests/testfile.png"
  #   And I click the button "Continue"
  #   Then I should see the phrase "Here is your file."

  Scenario: Test the interview "Validate and transform"
    Given I start the interview "docassemble.base:data/questions/examples/validation-code-phone.yml"
    Then I should see the phrase "What is your phone number?"
    And I set "Phone number" to "2025551234"
    And I click the button "Continue"
    Then I should see the phrase "Your phone number is (202) 555-1234"

  Scenario: Test the interview "Continuation page"
    Given I start the interview "docassemble.demo:data/questions/examples/continuation-page.yml"
    Then I should see the phrase "What is your first favorite fruit?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Do you have other favorite fruits besides apple?"
    And I should see the phrase "Hint: enter at least five."
    And I click the button "Yes"
    Then I should see the phrase "What is your second favorite fruit?"
    And I set "Fruit" to "peach"
    And I click the button "Continue"
    Then I should see the phrase "Do you have other favorite fruits besides apple and peach?"
    And I click the button "Yes"
    Then I should see the phrase "What is your third favorite fruit?"
    And I set "Fruit" to "pear"
    And I click the button "Continue"
    Then I should see the phrase "Do you have other favorite fruits besides apple, peach, and pear?"
    And I click the button "Yes"
    Then I should see the phrase "What is your fourth favorite fruit?"
    And I set "Fruit" to "banana"
    And I click the button "Continue"
    Then I should see the phrase "Do you have other favorite fruits besides apple, peach, pear, and banana?"
    And I click the button "Yes"
    Then I should see the phrase "What is your fifth favorite fruit?"
    And I set "Fruit" to "grapefruit"
    And I click the button "Continue"
    Then I should see the phrase "Do you have other favorite fruits besides apple, peach, pear, banana, and grapefruit?"
    And I click the button "No"
    Then I should see the phrase "Fruit form"
    And I should see the phrase "Official favorite fruits"
    And I should see the phrase "Continuation page"

  Scenario: Test the interview "Data structure"
    Given I start the interview "docassemble.demo:data/questions/examples/data-objects-gathered.yml"
  Then I should see the phrase "Does Larry Jones have any allergies?"
  And I click the button "Yes"
  Then I should see the phrase "Tell me about Larry Jones’s first allergy."
  And I set "Allergic to" to "peanuts"
  And I click the button "Continue"
  Then I should see the phrase "Summary"
  And I should see the phrase "Fred Smith is at fred@example.com and is good at guessing pennies but has trouble with peanuts and subway tokens. Larry Jones is at larry@example.com and is good at stapling and making coffee but has trouble with peanuts."

  Scenario: Test the interview "Data structure"
    Given I start the interview "docassemble.demo:data/questions/examples/data-objects.yml"
    Then I should see the phrase "Fred Smith is at fred@example.com and is good at guessing pennies but has trouble with peanuts and subway tokens. Larry Jones is at larry@example.com and is good at stapling and making coffee but has trouble with ."

  Scenario: Test the interview "Custom objects from file"
    Given I start the interview "docassemble.demo:data/questions/examples/fish-example-2.yml"
    Then I should see the phrase "Fish summary"
    And I should see the phrase "Fred Halibut has 500 scales."
    And I should see the phrase "Larry Halibut has 600 scales."
    And I click the button "Continue"
    Then I should see the phrase "Fish summary after change"
    And I should see the phrase "Fred Halibut has 500 scales."
    And I should see the phrase "Larry Halibut has 700 scales."
  ...
  Scenario: Test the interview "Editing uploads"
    ...
    And I click the button "Continue"
    And I wait 2 seconds
    Then I should see the phrase "Exhibit you have uploaded."
    And I click the button "Continue"
    Then I should see the phrase "Thank you for uploading one exhibit."
  ...
  Scenario: Test the interview "Disabled field"
    ...
    And I should see the phrase "Your favorite vegetable is turnip."
    And I should see the phrase "Note that the variable favorite_vegetable_placeholder is not defined."

  Scenario: Test the interview "Disabled field"
    Given I start the interview "docassemble.base:data/questions/examples/disabled-field.yml"
    Then I should see the phrase "What are your favorite things to eat?"
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."
    And I should see the phrase "The favorite_vegetable variable was not defined by the previous question because the field was disabled."

  Scenario: Test the interview "Manual attachments"
    Given I start the interview "docassemble.base:data/questions/examples/document-manual-code.yml"
    Then I should see the phrase "Your document is ready."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Manual attachments"
    Given I start the interview "docassemble.base:data/questions/examples/document-manual-jpg.yml"
    Then I should see the phrase "Your document is ready."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Manual attachments"
    Given I start the interview "docassemble.base:data/questions/examples/document-manual.yml"
    Then I should see the phrase "Your document is ready."
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Cancel Add or Edit"
    Given I start the interview "docassemble.base:data/questions/examples/edit-list-cancel.yml"
    Then I should see the phrase "Are there any fruits?"
    And I click the button "Yes"
    Then I should see the phrase "What is the name of the first fruit?"
    And I set "Name" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "How many seeds does apple have?"
    And I set "Seeds" to "4"
    And I click the button "Continue"
    Then I should see the phrase "Are there any more fruits?"
    And I click the button "No"
    Then I should see the phrase "Fruit table"
    And I click the button " Add a fruit"
    Then I should see the phrase "What is the name of the second fruit?"
  ...
  Scenario: Test the interview "Multiple choice items in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/item-grid-breakpoint.yml"
    Then I should see the phrase "Select your favorite number."
    And I click the option "6" under "Favorite number"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite number is 6."

  Scenario: Test the interview "Multiple choice items in a grid"
    Given I start the interview "docassemble.base:data/questions/examples/item-grid.yml"
    Then I should see the phrase "Select your favorite fruit."
    And I click the option "Peach" under "Favorite fruit"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is Peach."

  Scenario: Test the interview "JSON response"
    Given I start the interview "docassemble.base:data/questions/examples/json-response-ajax.yml"
    Then I should see the phrase "Tell me about your shipment."
    And I set "Weight (lbs)" to "20"
    And I select "Medium box" as the "Size"
    And I click the button "Calculate"
    And I wait 1 second
    Then I should see the phrase "That will cost $134.64."
    And I click the button "Continue"
    Then I should see the phrase "We will ship that right away."

  Scenario: Test the interview "Raw HTML"
    Given I start the interview "docassemble.base:data/questions/examples/raw-html.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Favorite fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite fruit is apple."
  ...
  Scenario: Test the interview "Review answers"
    Given I start the interview "docassemble.base:data/questions/examples/review-10.yml"
    Then I should see the phrase "Review your answers"
    And I click the second link " Edit"
    Then I should see the phrase "What is your favorite vegetable?"
    And I set "Favorite vegetable" to "potato"
    And I click the button "Continue"
    Then I should see the phrase "You said your favorite fruit was potato."
    And I click the button " Add another"
    Then I should see the phrase "What is the fifth fruit?"
    And I set "Fruit" to "Starfruit"
    And I click the button "Continue"
    Then I should see the phrase "Starfruit"
    And I click the button "Continue"
    Then I should see the phrase "Done"

  Scenario: Test the interview "Sort dictionary"
    Given I start the interview "docassemble.base:data/questions/examples/table-sort-dict.yml"
    Then I should see the phrase "Income from benefits"
    And I click the option "No" under "Do you get income from benefits?"
    And I click the button "Continue"
    Then I should see the phrase "Income from dividends"
    And I click the option "Yes" under "Do you get income from dividends?"
    And I wait 1 second
    And I set "How much do you get from dividends?" to "432"
    And I click the button "Continue"
    Then I should see the phrase "Income from employment"
    And I click the option "Yes" under "Do you get income from employment?"
    And I wait 1 second
    And I set "How much do you get from employment?" to "1298"
    And I click the button "Continue"
    Then I should see the phrase "Income from interest"
    And I click the option "No" under "Do you get income from interest?"
    And I click the button "Continue"
    Then I should see the phrase "Income from stocks"
    And I click the option "Yes" under "Do you get income from stocks?"
    And I wait 1 second
    And I set "How much do you get from stocks?" to "247"
    And I click the button "Continue"
    Then I should see the phrase "Summary"
    And I click the first link " Edit"
    Then I should see the phrase "Income from benefits"
  ...
  Scenario: Test the interview "Sort table"
    Given I start the interview "docassemble.base:data/questions/examples/table-sort.yml"
    Then I should see the phrase "Do you have any fruit?"
    And I click the button "Yes"
    Then I should see the phrase "What fruit should be added to the list?"
    And I set "Fruit" to "apple"
    ...
    And I click the button "Continue"
    Then I should see the phrase "When did you last eat a orange?"
    And I set "Date" to "04/05/2024"
    And I click the button "Continue"
    Then I should see the phrase "So far, the fruits include apple and orange. Are there any others?"
    And I click the button "No"
    Then I should see the phrase "Information about fruit"
    ...
    And I click the button "Continue"
    Then I should see the phrase "Information about fruit"
    And I should not see the phrase "orange"

  Scenario: Test the interview "Under text"
    Given I start the interview "docassemble.base:data/questions/examples/under-text.yml"
    Then I should see the phrase "What are your favorite things to eat?"
    And I should see the phrase "E.g., eggplant, turnips"
    And I set "Vegetable" to "turnips"
    And I should see the phrase "E.g., apples, oranges"
    And I set "Fruit" to "banana"
    And I click the button "Continue"
    Then I should see the phrase "target_variable is: “turnips”"

  Scenario: Test the interview "Language methods"
    Given I start the interview "docassemble.demo:data/questions/examples/daobject-language-functions.yml"
    Then I should see the phrase "Language functions"
    And I should see the phrase "possessive()"
    And I should see the phrase "Don’t eat the apple’s core."
    And I should see the phrase "Thomas Montague’s résumé is unimpressive."
    And I should see the phrase "object_possessive()"
    And I should see the phrase "Do you understand the thing’s intrinsic nature?"
    And I should see the phrase "Have you met the person’s dog yet?"
    And I should see the phrase "pronoun()"
    And I should see the phrase "Look at the apple, but do not stare at it."
    And I should see the phrase "Look at Thomas Montague, but do not stare at him."
    And I should see the phrase "pronoun_objective()"
    And I should see the phrase "Eat the apple, but not too much of it."
    And I should see the phrase "May an abundance of apple be granted unto you."
    And I should see the phrase "Teach Thomas Montague well, but do not bore him."
    And I should see the phrase "pronoun_subjective()"
    And I should see the phrase "If you polish the apple, it will be shiny."
    And I should see the phrase "You may win unlimited apple pie for life if you accept this limited time offer."
    And I should see the phrase "If you are nice to Thomas Montague, he will probably not be nice to you in return."
    And I should see the phrase "pronoun_possessive()"
    And I should see the phrase "You can squeeze the apple, but its juice will get all over your hands."
    And I should see the phrase "You have many fireplaces, but all your chimneys are filled up with insulation."
    And I should see the phrase "Thomas Montague drives, but his car is a piece of junk."
    And I should see the phrase "is_are_you()"
    And I should see the phrase "Is apple sweet?"
    And I should see the phrase "Are you sweet?"
    And I should see the phrase "yourself_or_name()"
    And I should see the phrase "Give the apple to yourself."
    And I should see the phrase "Give the apple to Thomas Montague."
    And I should see the phrase "itself()"
    And I should see the phrase "The apple can speak for itself."
    And I should see the phrase "You can speak for yourself."
    And I should see the phrase "Thomas Montague can speak for himself."
    And I should see the phrase "is_user()"
    And I should see the phrase "John Smith is the user."
    And I should see the phrase "do_question()"
    And I should see the phrase "Does apple exist?"
    And I should see the phrase "Do you exist?"
    And I should see the phrase "Does Thomas Montague exist?"
    And I should see the phrase "did_question()"
    And I should see the phrase "Did you invest in real estate?"
    And I should see the phrase "Did Thomas Montague invest in real estate?"
    And I should see the phrase "were_question()"
    And I should see the phrase "Were you present at the scene of the crime?"
    And I should see the phrase "Was Thomas Montague present at the scene of the crime?"
    And I should see the phrase "have_question()"
    And I should see the phrase "Have you followed the news about the apple festival?"
    And I should see the phrase "Has Thomas Montague followed the news about the apple festival?"
    And I should see the phrase "does_verb()"
    And I should see the phrase "You eat like a pig."
    And I should see the phrase "He eats like a pig."
    And I should see the phrase "did_verb()"
    And I should see the phrase "You went to the park."
    And I should see the phrase "He went to the park."
    And I should see the phrase "subjective_pronoun_or_name()"
    And I should see the phrase "You will not disappoint me again."
    And I should see the phrase "Thomas Montague will not disappoint me again."
    And I should see the phrase "pronoun_or_name()"
    And I should see the phrase "I gave the apple to you."
    And I should see the phrase "I gave the apple to Thomas Montague."

  Scenario: Test the interview "Testing for context"
    Given I start the interview "docassemble.demo:data/questions/examples/inside-of-class.yml"
    Then I should see the phrase "What is your name?"
    And I set "First" to "Herbert"
    And I set "Middle" to "J."
    And I set "Last" to "Rodin"
    And I click the button "Continue"
    Then I should see the phrase "Thanks, Herbert!"
    And I should see the phrase "The following document has been created for you."

  Scenario: Test the interview "Show fields with JavaScript"
    Given I start the interview "docassemble.demo:data/questions/examples/jsshowifmaybe.yml"
    Then I should see the phrase "Please fill in the following information."
    And I set "Favorite fruit" to "mango"
    And I set "Favorite vegetable" to "potato"
    And I click the option "Yes" under "Do you like mushrooms?"
    And I wait 1 second
    And I set "Favorite mushroom" to "portobella"
    And I click the option "I don’t know" under "Do you like mushrooms?"
    And I wait 1 second
    And I set "How could you now know?" to "I am an undecided eater."
    And I click the button "Continue"
    Then I should see the phrase "Thank you for that information."
    And I should see the phrase "You like mango and potato."
    And I should see the phrase "You said you don’t know if you like mushrooms. Your ridiculous explanation was:"
    And I should see the phrase "I am an undecided eater."

  Scenario: Test the interview "Point of view"
    Given I start the interview "docassemble.demo:data/questions/examples/language-functions.yml"
    Then I should see the phrase "Test of language methods"
    And I should see the phrase "Variable name is helper. The helper’s string representation is Robot. Am I going to the ball? My favorite fruit is apple. The apple should be given to me. The orange should be given to me. I belong in an apple orchard and visited an orange farm once. My favorite vegetable is turnips. Robot is not the user. Do I eat fruit? Did I eat mushrooms last Tuesday? Was I present at the ball last month? Have I befriended the cows in the field? The subject is I. The object is me. I returned the radishes to myself. Robot returned the potatoes to myself."
    And I should see the phrase "Variable name is user. Your string representation is Ursula User. Are you going to the ball? Your favorite fruit is apple. The apple should be given to you. The orange should be given to you. You belong in an apple orchard and visited an orange farm once. Your favorite vegetable is turnips. Ursula User is the user. Do you eat fruit? Did you eat mushrooms last Tuesday? Were you present at the ball last month? Have you befriended the cows in the field? The subject is you. The object is you. You returned the radishes to yourself. Ursula User returned the potatoes to yourself."
    And I should see the phrase "Variable name is user alias. Your string representation is Ursie User. Are you going to the ball? Your favorite fruit is apple. The apple should be given to you. The orange should be given to you. You belong in an apple orchard and visited an orange farm once. Your favorite vegetable is turnips. Ursie User is not the user. Do you eat fruit? Did you eat mushrooms last Tuesday? Were you present at the ball last month? Have you befriended the cows in the field? The subject is you. The object is you. You returned the radishes to yourself. Ursie User returned the potatoes to yourself."
    And I should see the phrase "Variable name is other user. The other user’s string representation is Harold User. Is Harold User going to the ball? His favorite fruit is apple. The apple should be given to him. The orange should be given to him. He belongs in an apple orchard and visited an orange farm once. Harold User’s favorite vegetable is turnips. Harold User is not the user. Does Harold User eat fruit? Did Harold User eat mushrooms last Tuesday? Was Harold User present at the ball last month? Has Harold User befriended the cows in the field? The subject is Harold User. The object is Harold User. He returned the radishes to Harold User. Harold User returned the potatoes to himself."
    And I should see the phrase "Variable name is company. The company’s string representation is ABC, Inc.. Is ABC, Inc. going to the ball? Its favorite fruit is apple. The apple should be given to it. The orange should be given to it. It belongs in an apple orchard and visited an orange farm once. ABC, Inc.’s favorite vegetable is turnips. ABC, Inc. is not the user. Does ABC, Inc. eat fruit? Did ABC, Inc. eat mushrooms last Tuesday? Was ABC, Inc. present at the ball last month? Has ABC, Inc. befriended the cows in the field? The subject is ABC, Inc.. The object is ABC, Inc.. It returned the radishes to ABC, Inc.. ABC, Inc. returned the potatoes to itself."
    And I should see the phrase "Variable name is thing. The thing’s string representation is apple tree. Is apple tree going to the ball? Its favorite fruit is apple. The apple should be given to it. The orange should be given to it. It belongs in an apple orchard and visited an orange farm once. Apple tree’s favorite vegetable is turnips. apple tree is not the user. Does apple tree eat fruit? Did apple tree eat mushrooms last Tuesday? Was apple tree present at the ball last month? Has apple tree befriended the cows in the field? The subject is apple tree. The object is apple tree. It returned the radishes to apple tree. apple tree returned the potatoes to itself."
    And I should see the phrase "Variable name is single list. The single list’s string representation is Fred Smith. Is Fred Smith going to the ball? His favorite fruit is apple. The apple should be given to him. The orange should be given to him. He belongs in an apple orchard and visited an orange farm once. Single list’s favorite vegetable is turnips. Please fetch one apple for Fred Smith, since there are one. Fred Smith is not the user. Does Fred Smith eat fruit? Did Fred Smith eat mushrooms last Tuesday? Was Fred Smith present at the ball last month? Has Fred Smith befriended the cows in the field? The subject is Fred Smith. The object is Fred Smith. He returned the radishes to Fred Smith. Fred Smith returned the potatoes to himself."
    And I should see the phrase "Variable name is multiple list. The multiple list’s string representation is Sally Jones and Peter Roberts. Are Sally Jones and Peter Roberts going to the ball? Their favorite fruit is apple. The apple should be given to them. The orange should be given to them. They belong in an apple orchard and visited an orange farm once. Multiple lists’ favorite vegetable is turnips. Please fetch two apples for Sally Jones and Peter Roberts, since there are two. Sally Jones and Peter Roberts is not the user. Do Sally Jones and Peter Roberts eat fruit? Did Sally Jones and Peter Roberts eat mushrooms last Tuesday? Were Sally Jones and Peter Roberts present at the ball last month? Have Sally Jones and Peter Roberts befriended the cows in the field? The subject is Sally Jones and Peter Roberts. The object is Sally Jones and Peter Roberts. They returned the radishes to Sally Jones and Peter Roberts. Sally Jones and Peter Roberts returned the potatoes to themselves."
    And I should see the phrase "Variable name is users. The users’s string representation is Ursula User and Harold User. Are you going to the ball? Your favorite fruit is apple. The apple should be given to you. The orange should be given to you. You belong in an apple orchard and visited an orange farm once. Users’ favorite vegetable is turnips. Please fetch two apples for Ursula User and Harold User, since there are two. Ursula User and Harold User is not the user. Do you eat fruit? Did you eat mushrooms last Tuesday? Were you present at the ball last month? Have you befriended the cows in the field? The subject is you. The object is you. You returned the radishes to yourselves. Ursula User and Harold User returned the potatoes to yourselves."
    And I should see the phrase "Variable name is helpers. The helpers’s string representation is ABC, Inc. and DEF, Inc.. Are we going to the ball? Our favorite fruit is apple. The apple should be given to us. The orange should be given to us. We belong in an apple orchard and visited an orange farm once. Helpers’ favorite vegetable is turnips. Please fetch two apples for ABC, Inc. and DEF, Inc., since there are two. ABC, Inc. and DEF, Inc. is not the user. Do we eat fruit? Did we eat mushrooms last Tuesday? Were we present at the ball last month? Have we befriended the cows in the field? The subject is we. The object is us. We returned the radishes to ourselves. ABC, Inc. and DEF, Inc. returned the potatoes to ourselves."

  Scenario: Test the interview "Accordion Review"
    Given I start the interview "docassemble.demo:data/questions/examples/testaccordion1.yml"
    Then I should see the phrase "Please review your answers."
    And I should see the phrase "You said your favorite cat was Tabby."
    And I should not see the phrase "You said your favorite fruit was Apple."
    And I should not see the phrase "You said your fashion aesthetic was Goth."
    And I click the button "Resume"

  Scenario: Test the interview "Accordion Fields"
    Given I start the interview "docassemble.demo:data/questions/examples/testaccordion2.yml"
    Then I should see the phrase "Tell me about your preferences"
    And I set "Favorite cat" to "Tabby"
    ...
    And I set "Favorite vegetable" to "Turnip"
    And I click the button "Continue"
    Then I should see the phrase "Your favorite cat is Tabby and your favorite dog is Dalmatian."

  Scenario: Test the interview "Accordion"
    Given I start the interview "docassemble.demo:data/questions/examples/testaccordion3.yml"
    Then I should see the phrase "Welcome to the interview."
  ...
  Scenario: Test the interview "Accordion Fields"
    Given I start the interview "docassemble.demo:data/questions/examples/testaccordion4.yml"
    Then I should see the phrase "Tell me about your preferences"
    And I should not see the phrase "Favorite fruit"
    ...
    And I click the button "Continue"
    Then I should see the phrase "Your favorite vegetable is turnip and your fashion aesthetic is Goth."
  ...
  Scenario: Test the interview "BackgroundAction"
    Given I start the interview "docassemble.base:data/questions/examples/background_action_object.yml"
    Then I should see the phrase "How much shall I add to 553?"
    And I set "Number" to "2"
    And I click the button "Continue"
  ...
  Scenario: Test the interview "Description of file types"
    Given I start the interview "docassemble.base:data/questions/examples/describe-file-types.yml"
    Then I should see the phrase "Here is your document."
    And I should see the phrase "The following document has been created for you."
    And I should see the phrase "Praecipe to discontinue"

  Scenario: Test the interview "DOCX format from RTF"
    Given I start the interview "docassemble.base:data/questions/examples/document-docx-from-rtf-standalone.yml"
    Then I should see the phrase "Here is your document."
    And I should see the phrase "The following document has been created for you."
    And I should see the phrase "Summary of Benefits"

  Scenario: Test the interview "No inline icons"
    Given I start the interview "docassemble.base:data/questions/examples/no-emojis.yml"
    Then I should see the phrase "Third quarter metrics"
    And I should see the phrase "far-fa-money-bill-alt"

  Scenario: Test the interview "Numbers"
    Given I start the interview "docassemble.base:data/questions/examples/number-field-numeric.yml"
    Then I should see the phrase "Describe your possessions."
    And I set "Number of cars" to "2"
    And I set "Ounces of gold" to "1.1"
    And I click the button "Continue"
    Then I should see the phrase "Result of question"
    And I should see the phrase "You have 2 cars."
    And I should see the phrase "You also have 1.1 ounces of gold."
  ...
  # Scenario: Test the interview "AI Helper Example"
  #   Given I start the interview "docassemble.demo:data/questions/aihelper-example.yml"

  # Scenario: Test the interview "AI Helper Included File"
  #   Given I start the interview "docassemble.demo:data/questions/aihelper.yml"

  # Scenario: Test the interview "Chatbot BG object"
  #   Given I start the interview "docassemble.demo:data/questions/examples/chatbot-bg-object.yml"

  # Scenario: Test the interview "Chatbot BG"
  #   Given I start the interview "docassemble.demo:data/questions/examples/chatbot-bg.yml"

  # Scenario: Test the interview "OpenAI Chatbot"
  #   Given I start the interview "docassemble.demo:data/questions/examples/chatbot-slow-object.yml"

  # Scenario: Test the interview "OpenAI Chatbot"
  #   Given I start the interview "docassemble.demo:data/questions/examples/chatbot-slow.yml"

  # Scenario: Test the interview "OpenAI Chatbot"
  #   Given I start the interview "docassemble.demo:data/questions/examples/chatbot.yml"

  Scenario: Test the interview ""
    Given I start the interview "docassemble.demo:data/questions/examples/interrelated.yml"
    Then I should see the phrase "Entities:"
    And I click the link " Add entity"
    Then I should see the phrase "Describe the first entity."
    And I set "Entity Name" to "ABC Inc."
    And I set "Form of Entity" to "Partnership"
    And I click the button "Continue"
    Then I should see the phrase "Entities:"
    And I click the link " Add entity"
    Then I should see the phrase "Describe the second entity."
    And I set "Entity Name" to "DEF Inc."
    And I set "Form of Entity" to "Corporation"
    And I click the button "Continue"
    Then I should see the phrase "Entities:"
    And I click the button "Continue"
    Then I should see the phrase "Corporate directors"
    And I should see the phrase "So far, you have added zero corporate directors."
    And I click the link " Add director"
    Then I should see the phrase "Add legal persons being corporate directors of any Entity"
    And I set "Name" to "Todd Jones"
    And I select "ABC Inc." as the "Director of"
    And I click the button "Continue"
    Then I should see the phrase "Corporate directors"
    And I should see the phrase "So far, you have added one corporate director."
    And I click the link " Add director"
    Then I should see the phrase "Add legal persons being corporate directors of any Entity"
    And I set "Name" to "Sally Smith"
    And I select "DEF Inc." as the "Director of"
    And I click the button "Continue"
    Then I should see the phrase "Corporate directors"
    And I should see the phrase "So far, you have added two corporate directors."
    And I click the button "Continue"
    Then I should see the phrase "Representatives"
    And I click the link " Add representative"
    Then I should see the phrase "Add natural persons being representatives of entities or corporate directors."
    And I set "Name" to "Rachel Rep"
    And I set "Date of birth" to "02/02/2002"
    And I select "Todd Jones" as the "Representing"
    And I click the button "Continue"
    Then I should see the phrase "Representatives"
    And I click the button "Continue"
    Then I should see the phrase "Summary"
    And I should see the phrase "Todd Jones, who is represented by Rachel Rep"
    And I should see the phrase "Todd Jones directs ABC Inc.."

  Scenario: Test the interview "Side process"
    Given I start the interview "docassemble.demo:data/questions/examples/navbar-button-action.yml"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Fruit" to "apples"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite vegetable?"
    And I click the link "Message a Lawyer"
    Then I should see the phrase "What would you like to ask the attorney on duty?"
    And I set "Your email address" to "jhpyle@gmail.com"
    And I set "Question" to "What is the meaning of life?"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for your question."
    And I should see the phrase "The lawyer on duty will answer your question promptly."
    And I click the button "Resume interview"
    Then I should see the phrase "What is your favorite vegetable?"
    And I set "Vegetable" to "potato"
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite legume?"
    And I set "Legume" to "beans"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for that information."
