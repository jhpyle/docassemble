...
#    And I should see "https://docassemble.org/demo.html" as the URL of the page
  ...
  Scenario: Test the interview "Mandatory code" with turnips
    Given I start the interview "docassemble.base:data/questions/examples/mandatory-code.yml"
    Then I should see the phrase "What is your favorite food?"
    And I set the text box to "turnips"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for your input."
  ...
  Scenario: Test the interview "ML from text area"
    ...
    And I set the text area to "I feel terrible."
    And I click the button "Continue"
  ...
  Scenario: Test the interview "ML from line of text"
    ...
    Then I should see the phrase "Describe how you feel."
    And I set the text box to "I feel terrible."
    And I click the button "Continue"
    Then I should see the phrase "You sound"
  ...
  Scenario: Test the interview "Name in Mako template"
    ...
    And I set "Company name" to "Example Inc."
    And I click the button "Continue"
    Then I should see the phrase "Do you wish to sue Example Inc.?"
    And I click the button "Yes"
  ...
  Scenario: Test the interview "Need directive"
    ...
    And I set "Favorite animal" to "Ocelot"
    And I click the button "Continue"
    Then I should see the phrase "Thank you for that information."
    And I should see the phrase "My favorite animal is Ocelot, too!"
  ...
  Scenario: Test the interview "Nested for loops"
    ...
    And I set "First" to "Ralph"
    And I set "Last" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "Does Ralph have any children?"
    And I click the button "Yes"
    Then I should see the phrase "What is the name of Ralph’s first child?"
    And I set "First" to "Peter"
    And I set "Last" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "Does Peter have any allergies?"
    And I click the button "No"
    Then I should see the phrase "Does Ralph have any children other than Peter?"
    And I click the button "Yes"
    Then I should see the phrase "What is the name of Ralph’s second child?"
    And I set "First" to "Sally"
    And I set "Last" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "Does Sally have any allergies?"
    And I click the button "Yes"
    Then I should see the phrase "What allergy does Sally have?"
    And I set "Allergy" to "cotton"
    And I click the button "Continue"
    Then I should see the phrase "Does Sally have any allergies other than cotton?"
    And I click the button "Yes"
    Then I should see the phrase "What allergy does Sally have?"
    And I set "Allergy" to "grapes"
    And I click the button "Continue"
    Then I should see the phrase "Does Sally have any allergies other than cotton and grapes?"
    And I click the button "No"
    Then I should see the phrase "Does Ralph have any children other than Peter and Sally?"
    And I click the button "No"
    ...
    And I set "Last" to "Jones"
    And I click the button "Continue"
    Then I should see the phrase "Does Henry have any children?"
    And I click the button "No"
    Then I should see the phrase "Is there another person?"
    And I click the button "No"
  ...
  Scenario: Test the interview "Mako for loops"
    ...
    Then I should see the phrase "Are there any other witnesses?"
    And I click the button "No"
    Then I should see the phrase "What food does Harold Smith like?"
    And I set "Food" to "turnips"
    And I click the button "Continue"
    Then I should see the phrase "Is there any other food that Harold Smith likes, besides turnips?"
    And I click the button "Yes"
    Then I should see the phrase "What food does Harold Smith like?"
    And I set "Food" to "radishes"
    And I click the button "Continue"
    Then I should see the phrase "Is there any other food that Harold Smith likes, besides turnips and radishes?"
    And I click the button "No"
    ...
    And I should see the phrase "Harold Smith is a witness who likes turnips and radishes. Henry Harrison is a witness who likes pie."    
  ...
  Scenario: Test the interview "Set variable to list of objects"
    ...
    And I click the button "Continue"
    Then I should see the phrase "The villains include Harry Potter and Tom Riddle."
  ...
  Scenario: Test the interview "Groups"
    ...
    And I should see the phrase "A dog has 4 feet. A human has 2 feet. A bird has 2 feet."
    And I should see the phrase "There are 4 feet on a dog. There are 2 feet on a human. There are 2 feet on a bird."
  ...
  Scenario: Test the interview "Bad example 2"
    ...
    Then I should see the phrase "What is your name?"
    And I set "First Name" to "Stephen"
