...
#    And I should see "https://docassemble.org/demo.html" as the URL of the page
  ...
  Scenario: Test the interview "Nested for loops"
    ...
    And I set "Last" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "Does Ralph Smith have any children?"
    And I click the button "Yes"
    Then I should see the phrase "What is the name of Ralph Smith’s first child?"
    And I set "First" to "Peter"
    And I set "Last" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "Does Peter Smith have any allergies?"
    And I click the button "No"
    Then I should see the phrase "Does Ralph Smith have any children other than Peter Smith?"
    And I click the button "Yes"
    Then I should see the phrase "What is the name of Ralph Smith’s second child?"
    And I set "First" to "Sally"
    And I set "Last" to "Smith"
    And I click the button "Continue"
    Then I should see the phrase "Does Sally Smith have any allergies?"
    And I click the button "Yes"
    Then I should see the phrase "What allergy does Sally Smith have?"
    And I set "Allergy" to "cotton"
    And I click the button "Continue"
    Then I should see the phrase "Does Sally Smith have any allergies other than cotton?"
    And I click the button "Yes"
    Then I should see the phrase "What allergy does Sally Smith have?"
    And I set "Allergy" to "grapes"
    And I click the button "Continue"
    Then I should see the phrase "Does Sally Smith have any allergies other than cotton and grapes?"
    And I click the button "No"
    Then I should see the phrase "Does Ralph Smith have any children other than Peter Smith and Sally Smith?"
    And I click the button "No"
  ...
  Scenario: Test the interview "File path and MIME type"
    ...
    And I should see the phrase "Path /usr/share/docassemble/local/lib/python2.7/site-packages/docassemble/base/data/static/hello.pdf has MIME type application/pdf."
    And I should see the phrase "docassemble.demo:data/static/house.png"
    And I should see the phrase "Path /usr/share/docassemble/local/lib/python2.7/site-packages/docassemble/demo/data/static/house.png has MIME type image/png."
    And I should see the phrase "https://docassemble.org/img/docassemble-logo.jpg"
    And I should see the phrase "has MIME type image/jpeg."
  ...
  Scenario: Test the interview "Fill fields with code in Mako"
    ...
    And I set "First Name" to "George"
    And I set "Last Name" to "Alexander"
    And I click the button "Continue"
    Then I should see the phrase "What is the address of George Alexander?"
    And I set "Address" to "123 Main St"
    And I set "City" to "Springfield"
    And I select "Georgia" as the "State"
    And I set "Zip" to "02001"
  ...
  Scenario: Test the interview "Sections as list"
    ...
    Then I should see the phrase "Welcome to the interview"
    Then I should see the phrase "[{'intro': 'Introduction'}, {'about': 'About you', 'subsections': [{'contact': 'Contact info'}, {'demographic': 'Demographics'}]}, {'prefs': 'Preferences'}, {'conclusion': 'Conclusion'}]"
  ...
  Scenario: Test the interview "someone already mentioned"
    ...
    And I select "John Smith" as the "Somebody already mentioned"
    And I click the button "Continue"
    Then I should see the phrase "Who is the guardian?"
    And I set "First Name" to "Sally"
    And I set "Last Name" to "Jones"
    And I click the button "Continue"
    Then I should see the phrase "The successor agent is John Smith."
    And I should see the phrase "The conservator is John Smith."
    And I should see the phrase "The guardian is Sally Jones."
  ...
  Scenario: Test the interview "DAList"
    ...
    And I set "Last Name" to "Grantor"
    And I click the button "Continue"
    Then I should see the phrase "What is the name of the seventh recipient?"
    And I set "First Name" to "Joseph"
    And I set "Last Name" to "Bertie"
    And I click the button "Continue"
    Then I should see the phrase "What is the name of the eighth recipient?"
    And I set "First Name" to "Tabitha"
    And I set "Last Name" to "Tertiary"
    And I click the button "Continue"
    Then I should see the phrase "The recipients"
    And I should see the phrase "Thomas Trustee is a recipient. Thomas Trustee is a recipient. Bernard Beneficiary is a recipient. Thomas Trustee is a recipient. Bernard Beneficiary is a recipient. George Grantor is a recipient. Joseph Bertie is a recipient. Tabitha Tertiary is a recipient."    
  ...
  Scenario: Test the interview "Objects from file"
    ...
    And I should see the phrase "{'items': ['nuts', 'bolts'], 'object': 'InventoryItem'}"
    And I should see the phrase "{'items': ['paper', 'staplers', 'toner'], 'object': 'InventoryItem'}"
  ...
  Scenario: Test the interview "Google Map"
    ...
    And I click the button "Continue"
    Then I should see the phrase "Where do you live?"
    And I set "Address" to "1234 Market Street"
  ...
  Scenario: Test the interview "Address autocomplete"
    ...
    And I set "Address" to "1234 Market St"
    And I set "City" to "Philadelphia"
    And I select "Pennsylvania" as the "State"
  ...
  Scenario: Test the interview "Background error callback"
    ...
    Then I should see the phrase "integer division or modulo by zero"
  ...
  Scenario: Test the interview "Object"
    Given I start the interview "docassemble.base:data/questions/examples/branch-error.yml"
  ...
  Scenario: Test the interview "File types" with static
    ...
    And I click the button "Continue"
    Then I should see the phrase "/usr/share/docassemble/local/lib/python2.7/site-packages/docassemble/base/data/static/cow.jpg"
  ...
  Scenario: Test the interview "Gather"
    Given I start the interview "docassemble.base:data/questions/examples/gather-fruit-incomplete.yml"
  ...
  Scenario: Test the interview "Mako for loops"
    Given I start the interview "docassemble.base:data/questions/examples/gather.yml"
  ...
  Scenario: Test the interview "Infinite loop"
    Given I start the interview "docassemble.base:data/questions/examples/infinite-loop-2.yml"
    Then I should see the phrase "There appears to be an infinite loop."
    And I should see the phrase "Variables in stack are foo, bar."
  ...
  Scenario: Test the interview "Missing mandatory"
    Given I start the interview "docassemble.base:data/questions/examples/no-mandatory.yml"
  ...
  Scenario: Test the interview "Number format"
    ...
    Then I should see the phrase "Your monthly income is 3595.27166667 dollars per month."
  ...
  Scenario: Test the interview "PDF fill-in with signature"
    ...
    And I click the button "Continue"
    Then I should see the phrase "Congratulations!"
    Then I should see the phrase "You have now transferred everything you own to Preston Nelson."
    Then I should see the phrase "Transfer of Ownership"
  ...
  Scenario: Test the interview "Questionless interview"
    Given I start the interview "docassemble.base:data/questions/examples/questionless.yml"
  ...
  Scenario: Test the interview "Predictive analytics"
    ...
    And I click the button "Continue"
    Then I should see the phrase "I think it is an apple."
    And I should see the phrase "Am I right?"
  ...
  Scenario: Test the interview "Predictive analytics"
    ...
    And I should see the phrase "I think it is an apple."
  ...
  Scenario: Test the interview "Including one .docx in another"
    ...
    And I click the button "Continue"
    Then I should see the phrase "What is your favorite fruit?"
    And I set "Favorite fruit" to "kiwi"
    And I click the button "Continue"
    Then I should see the phrase "Here is your document."
  ...
  Scenario: Test the interview "Test age"
    ...
    And I click the button "Continue"
    Then I should see the phrase "You are 28 years old."
  ...
  Scenario: Test the interview "Test pickling lots of objects"
    ...
    And I set "Pumpkin Name" to "John"
    And I click the button "Continue"
    ...
    And I should see the phrase "Your pumpkin is named John."
 ...
 Scenario: Test the interview "Back button inside question"
  ...
  Scenario: Test the interview "HTML in main page"
    ...
    And I set "Fruit" to "apple"
    And I click the button "Continue"
    Then I should see the phrase "Thank you, John Smith."
    And I should see the phrase "Click here to buy now!"
    And I should see the phrase "Need help? Call 888-555-3933 now!!!"
