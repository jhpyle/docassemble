...
RUN mkdir -p /etc/ssl/docassemble /usr/share/docassemble/playground-modules/docassemble /usr/share/docassemble/local /usr/share/docassemble/webapp /usr/share/docassemble/files /var/www/.pip /var/www/.cache /usr/share/docassemble/log /tmp/docassemble && chown www-data.www-data /var/www/.pip /var/www/.cache && chsh -s /bin/bash www-data
COPY Docker/playground-modules-init.py /usr/share/docassemble/playground-modules/docassemble/__init__.py
