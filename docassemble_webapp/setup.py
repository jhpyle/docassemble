...
if PY2:
    install_requires = ['docassemble==0.4.23', 'docassemble.base==0.4.23', 'docassemble.demo==0.4.23', 'beautifulsoup4', 'boto', 'boto3', 'celery[redis]==4.1.0', 'kombu==4.1.0', 'eventlet', 'greenlet', 'flask', 'flask-kvsession', 'flask-login', 'flask-mail', 'flask-sqlalchemy', 'flask-user<0.7', 'flask-babel', 'flask-wtf', 'flask-socketio', 'pip', 'psycopg2-binary', 'python-dateutil', 'rauth', 'requests', 'wtforms==2.1', 'setuptools', 'sqlalchemy', 'tailer', 'werkzeug', 'simplekv', 'gcs-oauth2-boto-plugin', 'psutil', 'twilio', 'pycurl', 'google-api-python-client', 'azure-storage', 'strict-rfc3339', 'pyotp', 'links-from-link-header', 'alembic', 'pandas', 'numpy', 'sklearn', 'scipy', 'gspread', 'oauth2client', 'google-auth', 'google-cloud-translate', 'google-cloud-storage', 'iso8601', 'textstat']
else:
    install_requires = ['docassemble==0.4.23', 'docassemble.base==0.4.23', 'docassemble.demo==0.4.23', 'beautifulsoup4', 'boto', 'boto3', 'celery[redis]', 'kombu', 'eventlet', 'greenlet', 'flask', 'flask-kvsession', 'flask-login', 'flask-mail', 'flask-sqlalchemy', 'flask-user<0.7', 'flask-babel', 'flask-wtf', 'flask-socketio', 'pip', 'psycopg2-binary', 'python-dateutil', 'rauth', 'requests', 'wtforms==2.1', 'setuptools', 'sqlalchemy', 'tailer', 'werkzeug', 'simplekv', 'gcs-oauth2-boto-plugin', 'psutil', 'twilio', 'pycurl', 'google-api-python-client', 'azure-storage', 'strict-rfc3339', 'pyotp', 'links-from-link-header', 'alembic', 'pandas', 'numpy', 'sklearn', 'scipy', 'gspread', 'oauth2client', 'google-auth', 'google-cloud-translate', 'google-cloud-storage', 'iso8601', 'textstat']
