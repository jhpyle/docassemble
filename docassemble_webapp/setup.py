...
if PY2:
    install_requires = ['docassemble==0.5.16', 'docassemble.base==0.5.16', 'docassemble.demo==0.5.16', 'beautifulsoup4', 'boto', 'boto3', 'celery[redis]==4.1.0', 'kombu==4.1.0', 'eventlet', 'greenlet', 'flask', 'flask-kvsession', 'flask-login', 'flask-mail', 'flask-sqlalchemy', 'flask-user<0.7', 'flask-babel', 'flask-wtf', 'flask-socketio', 'flask-cors', 'pip', 'psycopg2-binary', 'python-dateutil', 'rauth', 'requests', 'wtforms==2.1', 'setuptools', 'sqlalchemy', 'tailer', 'werkzeug', 'simplekv', 'gcs-oauth2-boto-plugin', 'psutil', 'twilio', 'pycurl', 'google-api-python-client', 'azure-storage', 'rfc3339', 'iso8601', 'pyotp', 'links-from-link-header', 'sklearn', 'scipy', 'gspread', 'oauth2client', 'google-auth', 'google-cloud-translate', 'google-cloud-storage', 'iso8601', 'textstat', 'XlsxWriter', 'netifaces']
else:
    install_requires = ['docassemble==0.5.16', 'docassemble.base==0.5.16', 'docassemble.demo==0.5.16', 'beautifulsoup4', 'boto', 'boto3', 'celery[redis]', 'kombu', 'eventlet', 'greenlet', 'flask', 'flask-kvsession', 'flask-login', 'flask-mail', 'flask-sqlalchemy', 'flask-user<0.7', 'flask-babel', 'flask-wtf', 'flask-socketio', 'flask-cors', 'pip', 'psycopg2-binary', 'python-dateutil', 'rauth', 'requests', 'wtforms==2.1', 'setuptools', 'sqlalchemy', 'tailer', 'werkzeug', 'simplekv', 'gcs-oauth2-boto-plugin', 'psutil', 'twilio', 'pycurl', 'google-api-python-client', 'azure-storage', 'rfc3339', 'iso8601', 'pyotp', 'links-from-link-header', 'sklearn', 'scipy', 'gspread', 'oauth2client', 'google-auth', 'google-cloud-translate', 'google-cloud-storage', 'iso8601', 'textstat', 'XlsxWriter', 'netifaces']
