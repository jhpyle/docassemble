...
setup(name='docassemble.webapp',
      ...
      dependency_links = ['git://github.com/jhpyle/docassemble.git#egg=docassemble&subdirectory=docassemble', 'git://github.com/jhpyle/docassemble.git#egg=docassemble.base&subdirectory=docassemble_base', 'git://github.com/jhpyle/docassemble.git#egg=docassemble.demo&subdirectory=docassemble_demo']
      zip_safe = False,
