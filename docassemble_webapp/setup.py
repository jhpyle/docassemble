...
setup(name='docassemble.webapp',
      ...
      dependency_links = ['git+https://github.com/jhpyle/docassemble.git@0.1#egg=docassemble-0.1&subdirectory=docassemble', 'git+https://github.com/jhpyle/docassemble.git@0.1#egg=docassemble.base-0.1&subdirectory=docassemble_base', 'git+https://github.com/jhpyle/docassemble.git@0.1#egg=docassemble.demo-0.1&subdirectory=docassemble_demo'],
      zip_safe = False,
