...
app.config['USE_MFA'] = True if daconfig.get('second factor authentication', False) is True else False
app.config['MFA_ROLES'] = daconfig.get('second factor authentication roles', ['admin', 'developer'])
