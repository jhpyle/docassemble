...
from docassemble.base.functions import get_current_question
...
class SimpleTextMachineLearner(MachineLearner):
    ...
    def delete_by_key(self, key):  # pylint: disable=useless-parent-delegation
        """Deletes all of the training data in the database that was added with a given key"""
        return super().delete_by_key(key)
