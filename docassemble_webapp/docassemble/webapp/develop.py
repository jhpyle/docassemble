...
class PlaygroundPackagesForm(FlaskForm):
    ...
    author_name = StringField(word('Author Name'), validators=[validators.Length(min=1, max=255)])
    author_email = StringField(word('Author E-mail'), validators=[validators.Length(min=1, max=255)])
