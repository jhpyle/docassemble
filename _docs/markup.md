...
[Python's `if` statement]: https://docs.python.org/3.8/tutorial/controlflow.html#if-statements
[Python's `for` statement]: https://docs.python.org/3.8/tutorial/controlflow.html#for-statements
