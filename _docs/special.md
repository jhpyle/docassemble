...
* <span></span>[`allow_cron`]: a special variable that is set to
  `True` if you want to allow the server to run [scheduled tasks]
  from the interview.
...
* <span></span>[`caller`]: within [Mako] the variable `caller` has a
  special meaning.
* <span></span>[`device_local`]: an object that will always be
  specific to a particular device of a particular user.
...
* <span></span>[`session_local`]: an object that is specific to a
  particular browser session of a user.
...
* <span></span>[`url_args`]: a dictionary available to interview code that contains
  ...
  loaded.
* <span></span>[`user_local`]: an object that is specific to a
  particular user in an interview.
...
[`DA`]: {{ site.baseurl }}/docs/functions.html#session query string
...
[`DAWeb`]: {{ site.baseurl }}/docs/objects.html#DAWeb
[`DAWebError`]: {{ site.baseurl }}/docs/objects.html#DAWebError
...
[`add_separators`]: {{ site.baseurl }}/docs/functions.html#add_separators
...
[`assemble_docx`]: {{ site.baseurl }}/docs/functions.html#assemble_docx
...
[`clear_explanations`]: {{ site.baseurl }}/docs/functions.html#clear_explanations
...
[`docx_concatenate`]: {{ site.baseurl }}/docs/functions.html#docx_concatenate
[`dow_of`]: {{ site.baseurl }}/docs/functions.html#dow_of
[`encode_name`]: {{ site.baseurl }}/docs/functions.html#encode_name
[`explain`]: {{ site.baseurl }}/docs/functions.html#explain
...
[`get_status`]: {{ site.baseurl }}/docs/functions.html#get_status
...
[`language_name`]: {{ site.baseurl }}/docs/functions.html#language_name
...
[`set_status`]: {{ site.baseurl }}/docs/functions.html#set_status
...
[`store_variables_snapshot`]: https://six.readthedocs.io/#store_variables_snapshot
...
[`verbatim`]: {{ site.baseurl }}/docs/functions.html#verbatim
