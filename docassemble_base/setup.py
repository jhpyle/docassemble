...
if PY2:
    install_requires = ['docassemble==0.5.5', 'python-docx==0.8.7', '3to2', 'astunparse', 'babel', 'bcrypt', 'blinker', 'cffi', 'fdfgen', 'guess-language-spirit', 'httplib2', 'itsdangerous', 'jellyfish==0.5.6', 'jinja2', 'lxml', 'mako', 'markdown', 'markupsafe', 'mdx-smartypants', 'namedentities==1.5.2', 'passlib', 'pillow', 'pip', 'pycparser', 'pycrypto', 'pycryptodomex', 'geopy', 'pygments', 'pyjwt', 'pypdf', 'pypdftk', 'PyPDF2', 'python-dateutil', 'pytz', 'pyyaml>=5.1', 'ruamel.yaml', 'qrcode', 'six', 'titlecase', 'wheel', 'pattern', 'tzlocal', 'us', 'phonenumbers', 'pycountry', 'ua-parser', 'user-agents', 'textstat==0.5.5', 'twine', 'docxtpl', 'pylatex', 'pandas', 'numpy', 'XlsxWriter', 'xlwt', 'future', 'pathlib', 'convertapi', 'subprocess32', 'pypng', 'openpyxl', 'xlrd', 'oauth2client', 'google-api-python-client', 'twilio', 'werkzeug', 'pycurl', 'docxcompose', 'alembic']
else:
    install_requires = ['docassemble==0.5.5', 'python-docx==0.8.7', '3to2', 'astunparse', 'babel', 'bcrypt', 'blinker', 'cffi', 'fdfgen', 'guess-language-spirit', 'httplib2', 'itsdangerous', 'jellyfish==0.5.6', 'jinja2', 'lxml', 'mako', 'markdown', 'markupsafe', 'mdx-smartypants', 'namedentities==1.5.2', 'passlib', 'pdfminer3k==1.3.1', 'pillow', 'pip', 'pycparser', 'pycryptodome', 'pycryptodomex', 'geopy', 'pygments', 'pyjwt', 'pypdf', 'pypdftk', 'PyPDF2', 'python-dateutil', 'pytz', 'pyyaml>=5.1', 'ruamel.yaml', 'qrcode', 'six', 'titlecase', 'wheel', 'pattern', 'tzlocal', 'us', 'phonenumbers', 'pycountry', 'ua-parser', 'user-agents', 'textstat==0.5.5', 'twine', 'docxtpl', 'pylatex', 'pandas', 'numpy', 'XlsxWriter', 'xlwt', 'future', 'pathlib', 'convertapi', 'pyzbar', 'pypng', 'openpyxl', 'xlrd', 'oauth2client', 'google-api-python-client', 'twilio', 'werkzeug', 'pycurl', 'docxcompose', 'alembic']
