    ...
    if hasattr(field, 'choicetype'):
        ...
        if field.datatype in ['checkboxes', 'object_checkboxes']:
            ...
            if 'nota' in status.extras and field.number in status.extras['nota'] and status.extras['nota'][field.number] is not False:
                ...
                if embedded:
                    inner_fieldlist.append('<input class="dafield' + str(field.number) + ' dacheckbox-embedded danota-checkbox" id="_ignore' + str(field.number) + '" type="checkbox" name="_ignore' + str(field.number) + '"' + disable_others_data + '/>&nbsp;<label for="_ignore' + str(field.number) + '" data-varname="' + safeid(from_safeid(saveas_string) + "[B" + myb64quote("None") + "]") + '">' + formatted_item + '</label>')
                else:
                    inner_fieldlist.append('<input aria-label="' + formatted_item + '" alt="' + formatted_item + '" data-labelauty="' + formatted_item + '|' + formatted_item + '" class="' + 'dafield' + str(field.number) + ' danota-checkbox da-to-labelauty checkbox-icon' + extra_checkbox + '"' + title_text + ' type="checkbox" name="_ignore' + str(field.number) + '"  data-varname="' + safeid(from_safeid(saveas_string) + "[B" + myb64quote("None") + "]") + '" ' + ischecked + disable_others_data + '/>')
