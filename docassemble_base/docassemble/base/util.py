...
class DACloud(DAObject):
    """Returns an object that can be used to interface with S3 or Azure."""
    @property
    def conn(self):
        """This property returns a boto3.resource() or BlockBlobService() object."""
        return server.cloud.conn
    @property
    def client(self):
        """This property returns a boto3.client() object."""
